...
typedef TMilli ADSenRFNodeP$Timer1$precision_tag;
typedef int16_t ADSenRFNodeP$ADSensorRead$val_t;
...
enum /*ADSenRFNodeC.ADSensor*/AdcC$0$__nesc_unnamed4286 {
  AdcC$0$ID = 0U
};
typedef TMilli /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$precision_tag;
typedef TMilli /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$precision_tag;
enum /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC*/AMResourceC$0$__nesc_unnamed4287 {
  AMResourceC$0$AM_RESOURCE_ID = 0U
};
enum AMResourceCenterC$__nesc_unnamed4288 {
...
enum RfHardwareRxC$__nesc_unnamed4289 {
  RfHardwareRxC$TOP_TASK_ID = 1U
};
enum /*RfMacBaseCsmaC.Alarm32khz32C.Alarm32khz16C*/Alarm32khz16C$1$__nesc_unnamed4290 {
...
enum /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC*/AMResourceC$2$__nesc_unnamed4291 {
  AMResourceC$2$AM_RESOURCE_ID = 1U
};
enum /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC*/AMResourceC$3$__nesc_unnamed4292 {
  AMResourceC$3$AM_RESOURCE_ID = 2U
};
enum DsnFilterCenterC$__nesc_unnamed4293 {
  DsnFilterCenterC$DSN_FILTER_COUNT = 1U
};
enum /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC*/AMResourceC$1$__nesc_unnamed4294 {
  AMResourceC$1$AM_RESOURCE_ID = 3U
};
# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
static  void ADSenRFNodeP$Boot$booted(void);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void ADSenRFNodeP$AMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void ADSenRFNodeP$Timer1$fired(void);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t *ADSenRFNodeP$Receive$receive(message_t *arg_0x7eb43010, void *arg_0x7eb431b0, uint8_t arg_0x7eb43338);
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  void ADSenRFNodeP$ADSensorRead$readDone(error_t arg_0x7eb65a88, ADSenRFNodeP$ADSensorRead$val_t arg_0x7eb65c10);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static  void ADSenRFNodeP$sensorDataTask$runTask(void);
#line 64
static  void ADSenRFNodeP$sendMsgTask$runTask(void);
...
static  void FlashIEEEP$FlashIEEE$WriteIEEE(uint8_t *arg_0x7ea553d8);
#line 5
static  uint16_t FlashIEEEP$FlashIEEE$GetShortAddress(void);

static  void FlashIEEEP$FlashIEEE$GetIEEE(uint8_t *arg_0x7ea60f08);
...
#line 43
static   void ActiveMessageAddressC$ActiveMessageAddress$setAddress(am_group_t arg_0x7ea51e58, am_addr_t arg_0x7ea44010);
# 3 "/opt/atos/tos/chips/cc2530/flash/HalFlash.nc"
static  error_t HalFlashP$HalFlash$read(uint8_t *arg_0x7ea41190, uint32_t arg_0x7ea41320, uint16_t arg_0x7ea414b0);



static  error_t HalFlashP$HalFlash$erase(uint32_t arg_0x7ea36170);
#line 5
static  error_t HalFlashP$HalFlash$write(uint32_t arg_0x7ea41958, uint8_t *arg_0x7ea41b00, uint16_t arg_0x7ea41c90);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
static   void /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$CaptureChannel2$default$captured(uint16_t arg_0x7e937ba0);
# 92 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
static   void /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm0$startAt(/*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm0$size_type arg_0x7e970e78, /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm0$size_type arg_0x7e966030);
#line 62
...
# 92 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
static   void /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm1$startAt(/*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm1$size_type arg_0x7e970e78, /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm1$size_type arg_0x7e966030);
#line 62
...
#line 92
static   void /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$Alarm$startAt(/*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$Alarm$size_type arg_0x7e970e78, /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$Alarm$size_type arg_0x7e966030);
#line 105
...
#line 118
static  void /*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$Timer$startOneShotAt(uint32_t arg_0x7eb049b8, uint32_t arg_0x7eb04b48);
#line 67
...
uint8_t arg_0x7e744990, 
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
error_t arg_0x7eb65a88, AdcP$Read$val_t arg_0x7eb65c10);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
static  error_t AdcP$Init$init(void);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static  void AdcP$signalReadDone$runTask(void);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$runTask(void);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AtosControl$start(void);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubAMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
#line 69
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$fired(void);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$runTask(void);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$fired(void);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AtosControl$start(void);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$ReceiveAck$receive(message_t *arg_0x7eb43010, void *arg_0x7eb431b0, uint8_t arg_0x7eb43338);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$sendDone(message_t *arg_0x7e662a60, error_t arg_0x7e662be8);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
...
static  void AMResourceCenterP$CoreSend$sendDone(message_t *arg_0x7e641dd8, error_t arg_0x7e640010);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t AMResourceCenterP$AtosControl$start(void);
# 9 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
static  void /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SubCoreSend$sendDone(message_t *arg_0x7e641dd8, error_t arg_0x7e640010);
#line 7
static  error_t /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$CoreSend$send(message_t *arg_0x7e6412e8, uint8_t arg_0x7e641470);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
#line 49
static  error_t /*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$enqueue(/*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$t arg_0x7e61b3e8);
...
static  /*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$t /*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$element(uint8_t arg_0x7e61b960);
...
#line 65
static  /*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$t /*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$remove(uint8_t arg_0x7e61a498);
#line 40
...
static  error_t RfMacBaseCsmaP$CoreSend$send(message_t *arg_0x7e6412e8, uint8_t arg_0x7e641470);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
static  error_t RfHardwareTxP$RfHardwareTx$txPrepare(uint8_t *arg_0x7e5bb6d8, uint8_t arg_0x7e5bb860);
...
#line 92
static   void /*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$Alarm$startAt(/*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$Alarm$size_type arg_0x7e970e78, /*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$Alarm$size_type arg_0x7e966030);
#line 55
static   void /*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$Alarm$start(/*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$Alarm$size_type arg_0x7e971d18);
...
static  uint8_t RfPacketP$Packet$payloadLength(message_t *arg_0x7eb21468);
#line 108
static  void *RfPacketP$Packet$getPayload(message_t *arg_0x7eb20840, uint8_t *arg_0x7eb209e8);
#line 83
static  void RfPacketP$Packet$setPayloadLength(message_t *arg_0x7eb21ad8, uint8_t arg_0x7eb21c60);
# 58 "/opt/tinyos-2.x/tos/interfaces/ActiveMessageAddress.nc"
static   void RfPacketP$ActiveMessageAddress$changed(void);
# 166 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_group_t RfPacketP$AMPacket$group(message_t *arg_0x7eb31d08);
#line 77
static  am_addr_t RfPacketP$AMPacket$source(message_t *arg_0x7eb33030);
#line 57
...
static  am_addr_t RfPacketP$AMPacket$destination(message_t *arg_0x7eb35a28);
#line 110
static  void RfPacketP$AMPacket$setSource(message_t *arg_0x7eb33e88, am_addr_t arg_0x7eb32030);
#line 92
static  void RfPacketP$AMPacket$setDestination(message_t *arg_0x7eb335f8, am_addr_t arg_0x7eb33788);
#line 136
static  am_id_t RfPacketP$AMPacket$type(message_t *arg_0x7eb32f08);
#line 125
static  bool RfPacketP$AMPacket$isForMe(message_t *arg_0x7eb327d8);
#line 176
static  void RfPacketP$AMPacket$setGroup(message_t *arg_0x7eb25558, am_group_t arg_0x7eb256e8);
...
static  bool RfPacketP$PacketEx$isValidPacket(message_t *arg_0x7e713190);
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t RfReliableMacPacketP$Packet$payloadLength(message_t *arg_0x7eb21468);
#line 108
static  void *RfReliableMacPacketP$Packet$getPayload(message_t *arg_0x7eb20840, uint8_t *arg_0x7eb209e8);
#line 83
static  void RfReliableMacPacketP$Packet$setPayloadLength(message_t *arg_0x7eb21ad8, uint8_t arg_0x7eb21c60);
# 5 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  uint8_t RfReliableMacPacketP$PacketEx$packetHeaderSize(void);
static  void *RfReliableMacPacketP$PacketEx$getPacketHeader(message_t *arg_0x7e714ca0);

static  bool RfReliableMacPacketP$PacketEx$isValidPacket(message_t *arg_0x7e713190);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
static  uint8_t RfReliableMacAckP$RfReliableMacAck$fillAckMessage(message_t *arg_0x7e6b1850, uint8_t arg_0x7e6b19e0, message_t *arg_0x7e6b1b90, rf_ack_t *arg_0x7e6b1d40);
static  void RfReliableMacAckP$RfReliableMacAck$receiveAckMessage(message_t *arg_0x7e6b0238, message_t *arg_0x7e6b03e8, rf_ack_t *arg_0x7e6b0598);
# 4 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAckEvent.nc"
static  uint8_t RfReliableMacAckP$RfReliableMacAckEvent$default$fillAckMessage(message_t *arg_0x7e42bb10, uint8_t arg_0x7e42bca0, message_t *arg_0x7e42be50, rf_ack_t *arg_0x7e428030);
static  void RfReliableMacAckP$RfReliableMacAckEvent$default$receiveAckMessage(message_t *arg_0x7e428508, message_t *arg_0x7e4286b8, rf_ack_t *arg_0x7e428868);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubReceive$receive(message_t *arg_0x7eb43010, void *arg_0x7eb431b0, uint8_t arg_0x7eb43338);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$runTask(void);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMSendAck$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AtosControl$start(void);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreReceive.nc"
static  void RfActiveMessageP$CoreReceive$receive(message_t *arg_0x7e3d1030);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
...
static  void RfMacBaseReceiveP$RfHardwareRx$rxPacket(uint8_t *arg_0x7e582570, uint8_t arg_0x7e5826f8);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t AtosMacP$AtosControl$start(void);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void AtosNetStdP$AMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t *AtosNetStdP$Receive$receive(message_t *arg_0x7eb43010, void *arg_0x7eb431b0, uint8_t arg_0x7eb43338);
# 17 "/opt/atos/tos/lib/atos/net/AtosNetStd/AtosNetStd.nc"
static  void AtosNetStdP$AtosNetStd$default$receivedReboot(anstd_reboot_t *arg_0x7e3766a8);

static  void AtosNetStdP$AtosNetStd$default$receivedTraceAck(message_t *arg_0x7e3741f8, anstd_trace_ack_t *arg_0x7e3743b8);
#line 15
static  void AtosNetStdP$AtosNetStd$default$receivedDiscovery(anstd_discovery_t *arg_0x7e377d20);


static  void AtosNetStdP$AtosNetStd$default$receivedTrace(message_t *arg_0x7e376b58, anstd_trace_t *arg_0x7e376d08);
#line 6
static  error_t AtosNetStdP$AtosNetStd$sendNodeStatusUp(uint16_t arg_0x7e37bd68);





static  void AtosNetStdP$AtosNetStd$default$beforeNodeStatusUp(anstd_node_status_t *arg_0x7e3771e0);

static  void AtosNetStdP$AtosNetStd$default$receivedNodeStatusUp(message_t *arg_0x7e377698, anstd_node_status_t *arg_0x7e377850);

static  void AtosNetStdP$AtosNetStd$default$receivedSetIEEE(anstd_setieee_t *arg_0x7e3761f8);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$SubAMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$AMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$SubAMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
#line 69
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$AMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$ReceiveAck$receive(message_t *arg_0x7eb43010, void *arg_0x7eb431b0, uint8_t arg_0x7eb43338);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMResource$sendDone(message_t *arg_0x7e662a60, error_t arg_0x7e662be8);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$SubReceive$receive(message_t *arg_0x7eb43010, void *arg_0x7eb431b0, uint8_t arg_0x7eb43338);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMSendAck$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMResource$sendDone(message_t *arg_0x7e662a60, error_t arg_0x7e662be8);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$sendDone(message_t *arg_0x7e662a60, error_t arg_0x7e662be8);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
#line 69
static  error_t ADSenRFNodeP$AMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  void *ADSenRFNodeP$Packet$getPayload(message_t *arg_0x7eb20840, uint8_t *arg_0x7eb209e8);
# 28 "/opt/atos/tos/chips/cc2530/adc/AdcControl.nc"
static  void ADSenRFNodeP$ADSensorControl$enable(uint8_t arg_0x7eb72370, uint8_t arg_0x7eb72500, uint8_t arg_0x7eb72688);
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void ADSenRFNodeP$Timer1$startPeriodic(uint32_t arg_0x7eb11788);
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static  error_t ADSenRFNodeP$ADSensorRead$read(void);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t ADSenRFNodeP$sensorDataTask$postTask(void);
#line 56
static   error_t ADSenRFNodeP$sendMsgTask$postTask(void);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t ADSenRFNodeP$AtosControl$start(void);
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t ADSenRFNodeP$AMPacket$source(message_t *arg_0x7eb33030);
# 30 "ADSenRFNodeP.nc"
enum ADSenRFNodeP$__nesc_unnamed4295 {
#line 30
  ADSenRFNodeP$sensorDataTask = 0U
};
#line 30
typedef int ADSenRFNodeP$__nesc_sillytask_sensorDataTask[ADSenRFNodeP$sensorDataTask];
...
enum ADSenRFNodeP$__nesc_unnamed4296 {
#line 37
  ADSenRFNodeP$sendMsgTask = 1U
};
#line 37
typedef int ADSenRFNodeP$__nesc_sillytask_sendMsgTask[ADSenRFNodeP$sendMsgTask];
#line 23
message_t ADSenRFNodeP$m_sensor_msg;



uint8_t *ADSenRFNodeP$p_sensor_payload;
uint16_t ADSenRFNodeP$dest_address;

static inline  void ADSenRFNodeP$sensorDataTask$runTask(void);
...
static inline  void ADSenRFNodeP$sendMsgTask$runTask(void);
...
static inline  void ADSenRFNodeP$AMSend$sendDone(message_t *msg, error_t success);
...
static inline  void ADSenRFNodeP$Boot$booted(void);
#line 65
static  void ADSenRFNodeP$ADSensorRead$readDone(error_t result, int16_t val);
#line 88
static inline  message_t *ADSenRFNodeP$Receive$receive(message_t *msg, void *payload, uint8_t len);
#line 104
static inline  void ADSenRFNodeP$Timer1$fired(void);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
static  void WatchDogP$WatchDog$resetCpu(void);
# 3 "/opt/atos/tos/chips/cc2530/flash/HalFlash.nc"
static  error_t FlashIEEEP$HalFlash$read(uint8_t *arg_0x7ea41190, uint32_t arg_0x7ea41320, uint16_t arg_0x7ea414b0);



static  error_t FlashIEEEP$HalFlash$erase(uint32_t arg_0x7ea36170);
#line 5
static  error_t FlashIEEEP$HalFlash$write(uint32_t arg_0x7ea41958, uint8_t *arg_0x7ea41b00, uint16_t arg_0x7ea41c90);
# 43 "/opt/tinyos-2.x/tos/interfaces/ActiveMessageAddress.nc"
static   void FlashIEEEP$ActiveMessageAddress$setAddress(am_group_t arg_0x7ea51e58, am_addr_t arg_0x7ea44010);
...
# 50 "/opt/tinyos-2.x/tos/interfaces/GpioCapture.nc"
static   void /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$CaptureChannel2$captured(uint16_t arg_0x7e937ba0);
# 67 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
...
#line 92
static   void /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$AlarmFrom$startAt(/*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$AlarmFrom$size_type arg_0x7e970e78, /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$AlarmFrom$size_type arg_0x7e966030);
#line 62
...
#line 92
static   void /*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$Alarm$startAt(/*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$Alarm$size_type arg_0x7e970e78, /*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$Alarm$size_type arg_0x7e966030);
#line 105
...
#line 118
static  void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$TimerFrom$startOneShotAt(uint32_t arg_0x7eb049b8, uint32_t arg_0x7eb04b48);
#line 67
...
enum AdcP$__nesc_unnamed4306 {
#line 129
  AdcP$signalReadDone = 5U
};
#line 129
...
#line 74
static inline  error_t AdcP$Read$read(uint8_t id);
#line 132
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$PacketEx$getPacketHeader(message_t *arg_0x7e714ca0);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$postTask(void);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$Packet$payloadLength(message_t *arg_0x7eb21468);
#line 83
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$Packet$setPayloadLength(message_t *arg_0x7eb21ad8, uint8_t arg_0x7eb21c60);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAtosControl$start(void);
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMPacket$destination(message_t *arg_0x7eb35a28);
#line 92
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMPacket$setDestination(message_t *arg_0x7eb335f8, am_addr_t arg_0x7eb33788);
# 48 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacRetrySendP.nc"
enum /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$__nesc_unnamed4307 {
#line 48
  RfReliableMacRetrySendP$0$resendTask = 6U
};
#line 48
typedef int /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$__nesc_sillytask_resendTask[/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask];
#line 19
uint8_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_sending = FALSE;
message_t */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_msg;
uint8_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_retry_times = 0;


static void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$signalDone(message_t *msg, error_t result);
#line 43
static error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$doSend(message_t *msg);




static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$runTask(void);
#line 74
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len);
#line 129
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAMSend$sendDone(message_t *msg, error_t error);
#line 150
bool /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_started = FALSE;
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AtosControl$start(void);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubAMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$source(message_t *arg_0x7eb33030);
#line 67
static  am_addr_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$destination(message_t *arg_0x7eb35a28);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$PacketEx$getPacketHeader(message_t *arg_0x7e714ca0);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$startOneShot(uint32_t arg_0x7eb11d58);




static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$stop(void);
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubPacket$payloadLength(message_t *arg_0x7eb21468);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$RfReliableMacAck$receiveAckMessage(message_t *arg_0x7e6b0238, message_t *arg_0x7e6b03e8, rf_ack_t *arg_0x7e6b0598);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$postTask(void);
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$startOneShot(uint32_t arg_0x7eb11d58);




static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$stop(void);
# 31 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
enum /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$__nesc_unnamed4308 {
#line 31
  RfReliableMacSendP$0$signalDoneTask = 7U
};
#line 31
typedef int /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$__nesc_sillytask_signalDoneTask[/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask];
#line 26
uint8_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending = FALSE;
message_t */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg;
error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_result;


static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$runTask(void);
#line 51
static void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDone(message_t *msg, error_t result);
#line 71
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$fired(void);
...
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$fired(void);
...
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len);
#line 139
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubAMSend$sendDone(message_t *msg, error_t error);
#line 158
static inline  message_t */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$ReceiveAck$receive(message_t *ack_msg, void *payload, uint8_t len);
#line 203
bool /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_started = FALSE;
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AtosControl$start(void);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$send(am_addr_t arg_0x7e662268, message_t *arg_0x7e662418, uint8_t arg_0x7e6625a0);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len);
#line 39
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$sendDone(message_t *msg, error_t error);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
...
static  void AMResourceCenterP$Packet$setPayloadLength(message_t *arg_0x7eb21ad8, uint8_t arg_0x7eb21c60);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t AMResourceCenterP$SubAtosControl$start(void);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
static  error_t AMResourceCenterP$CoreSend$send(message_t *arg_0x7e6412e8, uint8_t arg_0x7e641470);
# 57 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t AMResourceCenterP$AMPacket$address(void);
#line 110
static  void AMResourceCenterP$AMPacket$setSource(message_t *arg_0x7eb33e88, am_addr_t arg_0x7eb32030);
#line 92
static  void AMResourceCenterP$AMPacket$setDestination(message_t *arg_0x7eb335f8, am_addr_t arg_0x7eb33788);
#line 176
static  void AMResourceCenterP$AMPacket$setGroup(message_t *arg_0x7eb25558, am_group_t arg_0x7eb256e8);
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
static  error_t /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SubCoreSend$send(message_t *arg_0x7e6412e8, uint8_t arg_0x7e641470);
# 41 "/opt/tinyos-2.x/tos/interfaces/Random.nc"
...
static  error_t /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SendQueue$enqueue(/*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SendQueue$t arg_0x7e61b3e8);
...
static  /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SendQueue$t /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SendQueue$element(uint8_t arg_0x7e61b960);
...
# 9 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
static  void /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$CoreSend$sendDone(message_t *arg_0x7e641dd8, error_t arg_0x7e640010);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 4 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/RfHardwareTx.nc"
static  error_t RfMacBaseCsmaP$RfHardwareTx$txPrepare(uint8_t *arg_0x7e5bb6d8, uint8_t arg_0x7e5bb860);
static  error_t RfMacBaseCsmaP$RfHardwareTx$txGo(void);
# 55 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
static   void RfMacBaseCsmaP$BackoffTimer$start(RfMacBaseCsmaP$BackoffTimer$size_type arg_0x7e971d18);
...
# 9 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
static  void RfMacBaseCsmaP$CoreSend$sendDone(message_t *arg_0x7e641dd8, error_t arg_0x7e640010);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
static  void RfMacBaseCsmaP$FlashIEEE$GetIEEE(uint8_t *arg_0x7ea60f08);
...
# 5 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/RfHardwareRx.nc"
static  void /*RfHardwareRxC.RfHardwareRxP*/RfHardwareRxP$0$RfHardwareRx$rxPacket(uint8_t *arg_0x7e582570, uint8_t arg_0x7e5826f8);
# 42 "/opt/tinyos-2.x/tos/interfaces/GpioInterrupt.nc"
...
#line 92
static   void /*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$AlarmFrom$startAt(/*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$AlarmFrom$size_type arg_0x7e970e78, /*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$AlarmFrom$size_type arg_0x7e966030);
#line 62
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t RfReliableMacPacketP$SubPacket$payloadLength(message_t *arg_0x7eb21468);
#line 108
static  void *RfReliableMacPacketP$SubPacket$getPayload(message_t *arg_0x7eb20840, uint8_t *arg_0x7eb209e8);
#line 83
static  void RfReliableMacPacketP$SubPacket$setPayloadLength(message_t *arg_0x7eb21ad8, uint8_t arg_0x7eb21c60);
# 8 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  bool RfReliableMacPacketP$SubPacketEx$isValidPacket(message_t *arg_0x7e713190);
...
# 4 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAckEvent.nc"
static  uint8_t RfReliableMacAckP$RfReliableMacAckEvent$fillAckMessage(message_t *arg_0x7e42bb10, uint8_t arg_0x7e42bca0, message_t *arg_0x7e42be50, rf_ack_t *arg_0x7e428030);
static  void RfReliableMacAckP$RfReliableMacAckEvent$receiveAckMessage(message_t *arg_0x7e428508, message_t *arg_0x7e4286b8, rf_ack_t *arg_0x7e428868);
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$PacketEx$getPacketHeader(message_t *arg_0x7e714ca0);

static  bool /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$PacketEx$isValidPacket(message_t *arg_0x7e713190);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
static  uint8_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$RfReliableMacAck$fillAckMessage(message_t *arg_0x7e6b1850, uint8_t arg_0x7e6b19e0, message_t *arg_0x7e6b1b90, rf_ack_t *arg_0x7e6b1d40);
# 4 "/opt/atos/tos/lib/atos/utils/DsnFilter.nc"
static  bool /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$DsnFilter$filter(uint16_t arg_0x7e408ba8, uint8_t arg_0x7e408d30);
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  void */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubPacket$getPayload(message_t *arg_0x7eb20840, uint8_t *arg_0x7eb209e8);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$postTask(void);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$Receive$receive(message_t *arg_0x7eb43010, void *arg_0x7eb431b0, uint8_t arg_0x7eb43338);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMSendAck$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 166 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_group_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$group(message_t *arg_0x7eb31d08);
#line 77
static  am_addr_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$source(message_t *arg_0x7eb33030);
#line 67
static  am_addr_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$destination(message_t *arg_0x7eb35a28);
#line 92
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$setDestination(message_t *arg_0x7eb335f8, am_addr_t arg_0x7eb33788);
#line 176
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$setGroup(message_t *arg_0x7eb25558, am_group_t arg_0x7eb256e8);
# 47 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacReceiveP.nc"
enum /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$__nesc_unnamed4316 {
#line 47
  RfReliableMacReceiveP$0$sendAckTask = 11U
};
#line 47
typedef int /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$__nesc_sillytask_sendAckTask[/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask];
#line 37
message_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg;

static inline void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAck(message_t *msg);
...
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$runTask(void);




static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMSendAck$sendDone(message_t *msg, error_t result);




static inline  message_t */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 100
bool /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_started = FALSE;
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AtosControl$start(void);
# 8 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  bool RfActiveMessageP$PacketEx$isValidPacket(message_t *arg_0x7e713190);
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  void *RfActiveMessageP$Packet$getPayload(message_t *arg_0x7eb20840, uint8_t *arg_0x7eb209e8);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
...
static  am_id_t RfActiveMessageP$AMPacket$type(message_t *arg_0x7eb32f08);
#line 125
static  bool RfActiveMessageP$AMPacket$isForMe(message_t *arg_0x7eb327d8);
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreReceive.nc"
static  void RfMacBaseReceiveP$CoreReceive$receive(message_t *arg_0x7e3d1030);
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t AtosNetStdP$Packet$payloadLength(message_t *arg_0x7eb21468);
#line 108
static  void *AtosNetStdP$Packet$getPayload(message_t *arg_0x7eb20840, uint8_t *arg_0x7eb209e8);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t AtosNetStdP$AMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 4 "/opt/atos/tos/chips/cc2530/watchdog/WatchDog.nc"
static  void AtosNetStdP$WatchDog$resetCpu(void);
# 17 "/opt/atos/tos/lib/atos/net/AtosNetStd/AtosNetStd.nc"
static  void AtosNetStdP$AtosNetStd$receivedReboot(anstd_reboot_t *arg_0x7e3766a8);

static  void AtosNetStdP$AtosNetStd$receivedTraceAck(message_t *arg_0x7e3741f8, anstd_trace_ack_t *arg_0x7e3743b8);
#line 15
static  void AtosNetStdP$AtosNetStd$receivedDiscovery(anstd_discovery_t *arg_0x7e377d20);


static  void AtosNetStdP$AtosNetStd$receivedTrace(message_t *arg_0x7e376b58, anstd_trace_t *arg_0x7e376d08);
#line 12
static  void AtosNetStdP$AtosNetStd$beforeNodeStatusUp(anstd_node_status_t *arg_0x7e3771e0);

static  void AtosNetStdP$AtosNetStd$receivedNodeStatusUp(message_t *arg_0x7e377698, anstd_node_status_t *arg_0x7e377850);

static  void AtosNetStdP$AtosNetStd$receivedSetIEEE(anstd_setieee_t *arg_0x7e3761f8);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t AtosNetStdP$nodeStatusUpTask$postTask(void);
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void AtosNetStdP$RebootTimer$startPeriodic(uint32_t arg_0x7eb11788);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t AtosNetStdP$rebootTask$postTask(void);
# 8 "/opt/atos/tos/platforms/antc5/devices/FlashIEEE.nc"
static  void AtosNetStdP$FlashIEEE$WriteIEEE(uint8_t *arg_0x7ea553d8);
#line 7
static  void AtosNetStdP$FlashIEEE$GetIEEE(uint8_t *arg_0x7ea60f08);
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t AtosNetStdP$AMPacket$source(message_t *arg_0x7eb33030);
#line 57
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$SubAMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$PacketEx$getPacketHeader(message_t *arg_0x7e714ca0);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$AMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$Packet$payloadLength(message_t *arg_0x7eb21468);
#line 83
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$Packet$setPayloadLength(message_t *arg_0x7eb21ad8, uint8_t arg_0x7eb21c60);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
...
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$AMPacket$destination(message_t *arg_0x7eb35a28);
#line 92
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$AMPacket$setDestination(message_t *arg_0x7eb335f8, am_addr_t arg_0x7eb33788);
# 48 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacRetrySendP.nc"
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$SubAMSend$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$AMPacket$source(message_t *arg_0x7eb33030);
#line 67
static  am_addr_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$AMPacket$destination(message_t *arg_0x7eb35a28);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$PacketEx$getPacketHeader(message_t *arg_0x7e714ca0);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$AMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$TimeoutTimer$startOneShot(uint32_t arg_0x7eb11d58);
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$SubPacket$payloadLength(message_t *arg_0x7eb21468);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$RfReliableMacAck$receiveAckMessage(message_t *arg_0x7e6b0238, message_t *arg_0x7e6b03e8, rf_ack_t *arg_0x7e6b0598);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$AckTimer$startOneShot(uint32_t arg_0x7eb11d58);
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMResource$send(am_addr_t arg_0x7e662268, message_t *arg_0x7e662418, uint8_t arg_0x7e6625a0);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$PacketEx$getPacketHeader(message_t *arg_0x7e714ca0);

static  bool /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$PacketEx$isValidPacket(message_t *arg_0x7e713190);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
static  uint8_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$RfReliableMacAck$fillAckMessage(message_t *arg_0x7e6b1850, uint8_t arg_0x7e6b19e0, message_t *arg_0x7e6b1b90, rf_ack_t *arg_0x7e6b1d40);
# 4 "/opt/atos/tos/lib/atos/utils/DsnFilter.nc"
static  bool /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$DsnFilter$filter(uint16_t arg_0x7e408ba8, uint8_t arg_0x7e408d30);
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  void */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$SubPacket$getPayload(message_t *arg_0x7eb20840, uint8_t *arg_0x7eb209e8);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$Receive$receive(message_t *arg_0x7eb43010, void *arg_0x7eb431b0, uint8_t arg_0x7eb43338);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMSendAck$send(am_addr_t arg_0x7eb54ee8, message_t *arg_0x7eb530a8, uint8_t arg_0x7eb53230);
# 166 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_group_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMPacket$group(message_t *arg_0x7eb31d08);
#line 77
static  am_addr_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMPacket$source(message_t *arg_0x7eb33030);
#line 67
static  am_addr_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMPacket$destination(message_t *arg_0x7eb35a28);
#line 92
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMPacket$setDestination(message_t *arg_0x7eb335f8, am_addr_t arg_0x7eb33788);
#line 176
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMPacket$setGroup(message_t *arg_0x7eb25558, am_group_t arg_0x7eb256e8);
# 47 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacReceiveP.nc"
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMResource$send(am_addr_t arg_0x7e662268, message_t *arg_0x7e662418, uint8_t arg_0x7e6625a0);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$send(am_addr_t arg_0x7e662268, message_t *arg_0x7e662418, uint8_t arg_0x7e6625a0);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMSend$sendDone(message_t *arg_0x7eb52248, error_t arg_0x7eb523d0);
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len);
#line 39
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$sendDone(message_t *msg, error_t error);
...
#define FlashIEEEP$HalFlash$write(arg_0x7ea41958,arg_0x7ea41b00,arg_0x7ea41c90) HalFlashP$HalFlash$write(arg_0x7ea41958, arg_0x7ea41b00, arg_0x7ea41c90)


#define FlashIEEEP$HalFlash$erase(arg_0x7ea36170) HalFlashP$HalFlash$erase(arg_0x7ea36170)
...
# 3 "/opt/atos/tos/chips/cc2530/flash/HalFlash.nc"
#define FlashIEEEP$HalFlash$read(arg_0x7ea41190,arg_0x7ea41320,arg_0x7ea414b0) HalFlashP$HalFlash$read(arg_0x7ea41190, arg_0x7ea41320, arg_0x7ea414b0)
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ActiveMessageAddress.nc"
#define FlashIEEEP$ActiveMessageAddress$setAddress(arg_0x7ea51e58,arg_0x7ea44010) ActiveMessageAddressC$ActiveMessageAddress$setAddress(arg_0x7ea51e58, arg_0x7ea44010)
...
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$1$AMPacket$destination(arg_0x7eb35a28) RfPacketP$AMPacket$destination(arg_0x7eb35a28)
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
#define AMResourceP$2$AMResource$send(arg_0x7e662268,arg_0x7e662418,arg_0x7e6625a0) AMResourceCenterP$AMResource$send(AMResourceC$3$AM_RESOURCE_ID, arg_0x7e662268, arg_0x7e662418, arg_0x7e6625a0)
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacReceiveP$1$AMSendAck$send(arg_0x7eb54ee8,arg_0x7eb530a8,arg_0x7eb53230) AMResourceP$2$AMSend$send(arg_0x7eb54ee8, arg_0x7eb530a8, arg_0x7eb53230)
...
# 83 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define AMResourceCenterP$Packet$setPayloadLength(arg_0x7eb21ad8,arg_0x7eb21c60) RfPacketP$Packet$setPayloadLength(arg_0x7eb21ad8, arg_0x7eb21c60)
...
#define AMResourceCenterP$AMPacket$setGroup(arg_0x7eb25558,arg_0x7eb256e8) RfPacketP$AMPacket$setGroup(arg_0x7eb25558, arg_0x7eb256e8)
...
#define AMResourceCenterP$AMPacket$setDestination(arg_0x7eb335f8,arg_0x7eb33788) RfPacketP$AMPacket$setDestination(arg_0x7eb335f8, arg_0x7eb33788)
...
#define AMResourceCenterP$AMPacket$setSource(arg_0x7eb33e88,arg_0x7eb32030) RfPacketP$AMPacket$setSource(arg_0x7eb33e88, arg_0x7eb32030)
#line 57
...
# 49 "/opt/atos/tos/lib/atos/utils/QueueEx.nc"
#define RfMacBaseSendP$0$SendQueue$enqueue(arg_0x7e61b3e8) QueueExC$0$QueueEx$enqueue(arg_0x7e61b3e8)
#line 60
#define RfMacBaseSendP$0$SendQueue$element(arg_0x7e61b960) QueueExC$0$QueueEx$element(arg_0x7e61b960)
#line 17
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
#define AMResourceCenterP$CoreSend$send(arg_0x7e6412e8,arg_0x7e641470) RfMacBaseSendP$0$CoreSend$send(arg_0x7e6412e8, arg_0x7e641470)
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacSendP$1$AMSend$sendDone(arg_0x7eb52248,arg_0x7eb523d0) RfReliableMacRetrySendP$1$SubAMSend$sendDone(arg_0x7eb52248, arg_0x7eb523d0)
# 31 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
static inline  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$signalDoneTask$runTask(void)
{
  message_t *msg;
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacRetrySendP$1$AMSend$sendDone(arg_0x7eb52248,arg_0x7eb523d0) AtosNetStdP$AMSend$sendDone(arg_0x7eb52248, arg_0x7eb523d0)
# 48 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacRetrySendP.nc"
static inline  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$resendTask$runTask(void)
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define RfReliableMacSendP$1$TimeoutTimer$startOneShot(arg_0x7eb11d58) VirtualizeTimerC$0$Timer$startOneShot(4U, arg_0x7eb11d58)
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacSendP$1$SubPacket$payloadLength(arg_0x7eb21468) RfPacketP$Packet$payloadLength(arg_0x7eb21468)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
#define AMResourceP$1$AMResource$send(arg_0x7e662268,arg_0x7e662418,arg_0x7e6625a0) AMResourceCenterP$AMResource$send(AMResourceC$2$AM_RESOURCE_ID, arg_0x7e662268, arg_0x7e662418, arg_0x7e6625a0)
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
  /* atomic removed: atomic calls only */
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacSendP$1$SubAMSend$send(arg_0x7eb54ee8,arg_0x7eb530a8,arg_0x7eb53230) AMResourceP$1$AMSend$send(arg_0x7eb54ee8, arg_0x7eb530a8, arg_0x7eb53230)
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacPacketP$SubPacket$getPayload(arg_0x7eb20840,arg_0x7eb209e8) RfPacketP$Packet$getPayload(arg_0x7eb20840, arg_0x7eb209e8)
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacSendP$1$PacketEx$getPacketHeader(arg_0x7e714ca0) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e714ca0)
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacRetrySendP$1$SubAMSend$send(arg_0x7eb54ee8,arg_0x7eb530a8,arg_0x7eb53230) RfReliableMacSendP$1$AMSend$send(arg_0x7eb54ee8, arg_0x7eb530a8, arg_0x7eb53230)
...
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacRetrySendP$1$AMPacket$destination(arg_0x7eb35a28) RfPacketP$AMPacket$destination(arg_0x7eb35a28)
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacPacketP$SubPacket$payloadLength(arg_0x7eb21468) RfPacketP$Packet$payloadLength(arg_0x7eb21468)
# 20 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacPacketP.nc"
static inline  uint8_t RfReliableMacPacketP$Packet$payloadLength(message_t *msg)
{
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacRetrySendP$1$Packet$payloadLength(arg_0x7eb21468) RfReliableMacPacketP$Packet$payloadLength(arg_0x7eb21468)
# 57 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
...
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define AtosNetStdP$Packet$getPayload(arg_0x7eb20840,arg_0x7eb209e8) RfReliableMacPacketP$Packet$getPayload(arg_0x7eb20840, arg_0x7eb209e8)
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacRetrySendP$1$PacketEx$getPacketHeader(arg_0x7e714ca0) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e714ca0)
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacRetrySendP$1$AMPacket$setDestination(arg_0x7eb335f8,arg_0x7eb33788) RfPacketP$AMPacket$setDestination(arg_0x7eb335f8, arg_0x7eb33788)
# 83 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacPacketP$SubPacket$setPayloadLength(arg_0x7eb21ad8,arg_0x7eb21c60) RfPacketP$Packet$setPayloadLength(arg_0x7eb21ad8, arg_0x7eb21c60)
...
# 83 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacRetrySendP$1$Packet$setPayloadLength(arg_0x7eb21ad8,arg_0x7eb21c60) RfReliableMacPacketP$Packet$setPayloadLength(arg_0x7eb21ad8, arg_0x7eb21c60)
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define AtosNetStdP$AMSend$send(arg_0x7eb54ee8,arg_0x7eb530a8,arg_0x7eb53230) RfReliableMacRetrySendP$1$AMSend$send(arg_0x7eb54ee8, arg_0x7eb530a8, arg_0x7eb53230)
...
#define AtosNetStdP$AtosNetStd$beforeNodeStatusUp(arg_0x7e3771e0) AtosNetStdP$AtosNetStd$default$beforeNodeStatusUp(arg_0x7e3771e0)
...
# 7 "/opt/atos/tos/platforms/antc5/devices/FlashIEEE.nc"
#define AtosNetStdP$FlashIEEE$GetIEEE(arg_0x7ea60f08) FlashIEEEP$FlashIEEE$GetIEEE(arg_0x7ea60f08)
...
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define AtosNetStdP$RebootTimer$startPeriodic(arg_0x7eb11788) VirtualizeTimerC$0$Timer$startPeriodic(5U, arg_0x7eb11788)
# 54 "/opt/atos/tos/lib/atos/net/AtosNetStd/AtosNetStdP.nc"
static inline  void AtosNetStdP$rebootTask$runTask(void)
{
...
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$0$AMPacket$destination(arg_0x7eb35a28) RfPacketP$AMPacket$destination(arg_0x7eb35a28)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
#define AMResourceP$3$AMResource$send(arg_0x7e662268,arg_0x7e662418,arg_0x7e6625a0) AMResourceCenterP$AMResource$send(AMResourceC$1$AM_RESOURCE_ID, arg_0x7e662268, arg_0x7e662418, arg_0x7e6625a0)
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
#line 17
  ...
  return /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$send(addr, msg, len);
}

# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacReceiveP$0$AMSendAck$send(arg_0x7eb54ee8,arg_0x7eb530a8,arg_0x7eb53230) AMResourceP$3$AMSend$send(arg_0x7eb54ee8, arg_0x7eb530a8, arg_0x7eb53230)
# 39 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacReceiveP.nc"
static inline void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAck(message_t *msg)
{
  if (/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMSendAck$send(/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$destination(msg), msg, sizeof(rf_ack_t )) != 0) 
    {
    }
}
...
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$runTask(void)
{
  /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAck(&/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg);
}
...
# 9 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
#define RfMacBaseSendP$0$CoreSend$sendDone(arg_0x7e641dd8,arg_0x7e640010) AMResourceCenterP$CoreSend$sendDone(arg_0x7e641dd8, arg_0x7e640010)
...
# 9 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
#define RfMacBaseCsmaP$CoreSend$sendDone(arg_0x7e641dd8,arg_0x7e640010) RfMacBaseSendP$0$SubCoreSend$sendDone(arg_0x7e641dd8, arg_0x7e640010)
# 53 "/opt/atos/tos/lib/atos/net/AtosMac/macbase/RfMacBaseCsmaP.nc"
static inline  void RfMacBaseCsmaP$signalDoneTask$runTask(void)
{
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define AMResourceP$3$AMSend$sendDone(arg_0x7eb52248,arg_0x7eb523d0) RfReliableMacReceiveP$0$AMSendAck$sendDone(arg_0x7eb52248, arg_0x7eb523d0)
...
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$sendDone(message_t *msg, error_t error)
{
  ...
  /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMSend$sendDone(msg, error);
}
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define AMResourceP$2$AMSend$sendDone(arg_0x7eb52248,arg_0x7eb523d0) RfReliableMacReceiveP$1$AMSendAck$sendDone(arg_0x7eb52248, arg_0x7eb523d0)
# 39 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMResource$sendDone(message_t *msg, error_t error)
{
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define RfReliableMacSendP$1$AckTimer$startOneShot(arg_0x7eb11d58) VirtualizeTimerC$0$Timer$startOneShot(3U, arg_0x7eb11d58)
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define AMResourceP$1$AMSend$sendDone(arg_0x7eb52248,arg_0x7eb523d0) RfReliableMacSendP$1$SubAMSend$sendDone(arg_0x7eb52248, arg_0x7eb523d0)
# 39 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMResource$sendDone(message_t *msg, error_t error)
{
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define RfReliableMacSendP$0$AckTimer$startOneShot(arg_0x7eb11d58) VirtualizeTimerC$0$Timer$startOneShot(1U, arg_0x7eb11d58)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacSendP$0$PacketEx$getPacketHeader(arg_0x7e714ca0) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e714ca0)
# 139 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubAMSend$sendDone(message_t *msg, error_t error)
{
  if (/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending) 
    {
      if (error == 0) 
        {
          rf_rmac_header_t *header = /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$PacketEx$getPacketHeader(msg);

#line 146
          if (header->ack_req) 
            {
              /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$startOneShot(50);
              return;
            }
        }

      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDone(msg, error);
    }
}

# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define AMResourceP$0$AMSend$sendDone(arg_0x7eb52248,arg_0x7eb523d0) RfReliableMacSendP$0$SubAMSend$sendDone(arg_0x7eb52248, arg_0x7eb523d0)
# 39 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$sendDone(message_t *msg, error_t error)
{
  ...
  /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMSend$sendDone(msg, error);
}
...
# 55 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
#define RfMacBaseCsmaP$BackoffTimer$start(arg_0x7e971d18) TransformAlarmC$1$Alarm$start(arg_0x7e971d18)
# 14 "/opt/atos/tos/chips/rf2530/hardware/txrx/RfHardwareTxP.nc"
static inline void RfHardwareTxP$writeTxfifo(uint8_t *buf, uint8_t len)
{
  uint8_t i;
...
# 4 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/RfHardwareTx.nc"
#define RfMacBaseCsmaP$RfHardwareTx$txPrepare(arg_0x7e5bb6d8,arg_0x7e5bb860) RfHardwareTxP$RfHardwareTx$txPrepare(arg_0x7e5bb6d8, arg_0x7e5bb860)
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
#define RfMacBaseSendP$0$SubCoreSend$send(arg_0x7e6412e8,arg_0x7e641470) RfMacBaseCsmaP$CoreSend$send(arg_0x7e6412e8, arg_0x7e641470)
...
# 92 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
#define TransformAlarmC$1$AlarmFrom$startAt(arg_0x7e970e78,arg_0x7e966030) HplCC2530Timer1P$0$Alarm1$startAt(arg_0x7e970e78, arg_0x7e966030)
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAMSend$sendDone(message_t *msg, error_t error)
{
  if (/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_sending) 
    {
      if (error == 0) 
        {
          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$signalDone(msg, error);
        }
      else 
        {
          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$postTask();
        }
    }
}

# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacSendP$0$AMSend$sendDone(arg_0x7eb52248,arg_0x7eb523d0) RfReliableMacRetrySendP$0$SubAMSend$sendDone(arg_0x7eb52248, arg_0x7eb523d0)
# 31 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$runTask(void)
{
  message_t *msg;
...
#line 40
      ...
      msg = /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg;
      result = /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_result;
    }
#line 45
    __nesc_atomic_end(__nesc_atomic); }

  /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMSend$sendDone(msg, result);
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 48
    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending = FALSE;
#line 48
    __nesc_atomic_end(__nesc_atomic); }
}
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacRetrySendP$0$AMSend$sendDone(arg_0x7eb52248,arg_0x7eb523d0) ADSenRFNodeP$AMSend$sendDone(arg_0x7eb52248, arg_0x7eb523d0)
# 48 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacRetrySendP.nc"
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$runTask(void)
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
#line 54
      ...
      if (/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_retry_times++ < 20) 
        {
          if (/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$doSend(/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_msg) != 0) 
            {
              ;
              /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$postTask();
            }
      ...
      else 
        {
          ...
          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$signalDone(/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_msg, ERR_MAC_RETRY_MAX);
        }
    }
#line 70
    __nesc_atomic_end(__nesc_atomic); }
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define RfReliableMacSendP$0$TimeoutTimer$startOneShot(arg_0x7eb11d58) VirtualizeTimerC$0$Timer$startOneShot(2U, arg_0x7eb11d58)
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacSendP$0$SubPacket$payloadLength(arg_0x7eb21468) RfPacketP$Packet$payloadLength(arg_0x7eb21468)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
#define AMResourceP$0$AMResource$send(arg_0x7e662268,arg_0x7e662418,arg_0x7e6625a0) AMResourceCenterP$AMResource$send(AMResourceC$0$AM_RESOURCE_ID, arg_0x7e662268, arg_0x7e662418, arg_0x7e6625a0)
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
  /* atomic removed: atomic calls only */
  ...
  return /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$send(addr, msg, len);
}

# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacSendP$0$SubAMSend$send(arg_0x7eb54ee8,arg_0x7eb530a8,arg_0x7eb53230) AMResourceP$0$AMSend$send(arg_0x7eb54ee8, arg_0x7eb530a8, arg_0x7eb53230)
# 89 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
  error_t result;
...
#line 102
    ...
    result = /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubAMSend$send(addr, msg, /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubPacket$payloadLength(msg));

    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$startOneShot(10000);

    if (result == 0) 
      {
        /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg = msg;
        /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending = TRUE;
      }
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacRetrySendP$0$SubAMSend$send(arg_0x7eb54ee8,arg_0x7eb530a8,arg_0x7eb53230) RfReliableMacSendP$0$AMSend$send(arg_0x7eb54ee8, arg_0x7eb530a8, arg_0x7eb53230)
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacRetrySendP$0$AMPacket$destination(arg_0x7eb35a28) RfPacketP$AMPacket$destination(arg_0x7eb35a28)
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacRetrySendP$0$Packet$payloadLength(arg_0x7eb21468) RfReliableMacPacketP$Packet$payloadLength(arg_0x7eb21468)
...
# 92 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
#define AlarmToTimerC$0$Alarm$startAt(arg_0x7e970e78,arg_0x7e966030) TransformAlarmC$0$Alarm$startAt(arg_0x7e970e78, arg_0x7e966030)
...
#define VirtualizeTimerC$0$TimerFrom$startOneShotAt(arg_0x7eb049b8,arg_0x7eb04b48) AlarmToTimerC$0$Timer$startOneShotAt(arg_0x7eb049b8, arg_0x7eb04b48)
...
static inline  void /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$fired(void)
{
  if (/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending) 
    {
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDone(/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg, ERR_MAC_NO_ACK);
    }
}
...
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
#define ADSenRFNodeP$sensorDataTask$postTask(void) SchedulerBasicP$TaskBasic$postTask(ADSenRFNodeP$sensorDataTask)
# 104 "ADSenRFNodeP.nc"
static inline  void ADSenRFNodeP$Timer1$fired(void)
{
  ADSenRFNodeP$sensorDataTask$postTask();
}
...
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static  void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7e7a9030){
#line 72
...
#line 72
    case 1U:
#line 72
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$fired();
#line 72
      break;
#line 72
    case 2U:
#line 72
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$fired();
#line 72
      break;
#line 72
    case 3U:
...
#line 72
    case 6U:
#line 72
      ADSenRFNodeP$Timer1$fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7e7a9030);
#line 72
      break;
#line 72
    }
...
# 92 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
#define TransformAlarmC$0$AlarmFrom$startAt(arg_0x7e970e78,arg_0x7e966030) HplCC2530Timer1P$0$Alarm0$startAt(arg_0x7e970e78, arg_0x7e966030)
...
# 83 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacRetrySendP$0$Packet$setPayloadLength(arg_0x7eb21ad8,arg_0x7eb21c60) RfReliableMacPacketP$Packet$setPayloadLength(arg_0x7eb21ad8, arg_0x7eb21c60)
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacRetrySendP$0$AMPacket$setDestination(arg_0x7eb335f8,arg_0x7eb33788) RfPacketP$AMPacket$setDestination(arg_0x7eb335f8, arg_0x7eb33788)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacRetrySendP$0$PacketEx$getPacketHeader(arg_0x7e714ca0) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e714ca0)
...
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
  ...
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    {
      rf_rmac_header_t *header = /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$PacketEx$getPacketHeader(msg);
      rf_metadata_t *metadata = (rf_metadata_t *)msg->metadata;
...
#line 85
      ...
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMPacket$setDestination(msg, addr);
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$Packet$setPayloadLength(msg, len);


      result = /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$doSend(msg);

      if (result == 0) 
        {
          rf_rmac_dsn++;
          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_sending = TRUE;
          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_msg = msg;
          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_retry_times = 0;
        }
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define ADSenRFNodeP$AMSend$send(arg_0x7eb54ee8,arg_0x7eb530a8,arg_0x7eb53230) RfReliableMacRetrySendP$0$AMSend$send(arg_0x7eb54ee8, arg_0x7eb530a8, arg_0x7eb53230)
# 37 "ADSenRFNodeP.nc"
static inline  void ADSenRFNodeP$sendMsgTask$runTask(void)
{

  if (ADSenRFNodeP$AMSend$send(1, &ADSenRFNodeP$m_sensor_msg, 2) != 0) 
    {
      ADSenRFNodeP$sensorDataTask$postTask();
    }
}
...
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static  void AdcP$Read$readDone(uint8_t arg_0x7e744990, error_t arg_0x7eb65a88, AdcP$Read$val_t arg_0x7eb65c10){
#line 63
  switch (arg_0x7e744990) {
#line 63
    case /*ADSenRFNodeC.ADSensor*/AdcC$0$ID:
#line 63
      ADSenRFNodeP$ADSensorRead$readDone(arg_0x7eb65a88, arg_0x7eb65c10);
#line 63
      break;
#line 63
    default:
#line 63
      AdcP$Read$default$readDone(arg_0x7e744990, arg_0x7eb65a88, arg_0x7eb65c10);
#line 63
      break;
#line 63
    }
...
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
#define ADSenRFNodeP$ADSensorRead$read(void) AdcP$Read$read(AdcC$0$ID)
...
# 28 "/opt/atos/tos/chips/cc2530/adc/AdcControl.nc"
#define ADSenRFNodeP$ADSensorControl$enable(arg_0x7eb72370,arg_0x7eb72500,arg_0x7eb72688) AdcP$AdcControl$enable(AdcC$0$ID, arg_0x7eb72370, arg_0x7eb72500, arg_0x7eb72688)
# 30 "ADSenRFNodeP.nc"
static inline  void ADSenRFNodeP$sensorDataTask$runTask(void)
{
  ADSenRFNodeP$ADSensorControl$enable(0x80, 0x30, 0x04);
  ADSenRFNodeP$ADSensorRead$read();
}

# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
#define ADSenRFNodeP$sendMsgTask$postTask(void) SchedulerBasicP$TaskBasic$postTask(ADSenRFNodeP$sendMsgTask)
...
#line 51
  result = ecombine(result, AdcP$Init$init());
#line 51
...
#line 51
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define ADSenRFNodeP$Packet$getPayload(arg_0x7eb20840,arg_0x7eb209e8) RfReliableMacPacketP$Packet$getPayload(arg_0x7eb20840, arg_0x7eb209e8)
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define ADSenRFNodeP$Timer1$startPeriodic(arg_0x7eb11788) VirtualizeTimerC$0$Timer$startPeriodic(6U, arg_0x7eb11788)
...
# 7 "/opt/atos/tos/platforms/antc5/devices/FlashIEEE.nc"
#define RfMacBaseCsmaP$FlashIEEE$GetIEEE(arg_0x7ea60f08) FlashIEEEP$FlashIEEE$GetIEEE(arg_0x7ea60f08)
...
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AtosControl$start(void)
{
  ...
  {
    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending = FALSE;
    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_result = FAIL;


    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$stop();
    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$stop();

    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_started = TRUE;
...
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AtosControl$start(void)
{
  /* atomic removed: atomic calls only */
  {
    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_sending = FALSE;
    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_retry_times = 0;

    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAtosControl$start();

    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_started = TRUE;
...
static inline  error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AtosControl$start(void)
{
  /* atomic removed: atomic calls only */
  {
    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_started = TRUE;

    memset(&/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg, 0, sizeof /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg);
...
#line 4
  result = ecombine(result, /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AtosControl$start());
#line 4
  result = ecombine(result, /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AtosControl$start());
#line 4
...
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
#define ADSenRFNodeP$AtosControl$start(void) AtosMacP$AtosControl$start()
# 53 "ADSenRFNodeP.nc"
static inline  void ADSenRFNodeP$Boot$booted(void)
{
...
#line 57
  ;
  ADSenRFNodeP$AtosControl$start();

  ADSenRFNodeP$Timer1$startPeriodic(2000);
  ADSenRFNodeP$p_sensor_payload = ADSenRFNodeP$Packet$getPayload(&ADSenRFNodeP$m_sensor_msg, (void *)0);
}

# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
#define RealMainP$Boot$booted(void) ADSenRFNodeP$Boot$booted()
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
#define RfActiveMessageP$Snoop$receive(arg_0x7e3d6bb0,arg_0x7eb43010,arg_0x7eb431b0,arg_0x7eb43338) RfActiveMessageP$Snoop$default$receive(arg_0x7e3d6bb0, arg_0x7eb43010, arg_0x7eb431b0, arg_0x7eb43338)
...
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define ADSenRFNodeP$AMPacket$source(arg_0x7eb33030) RfPacketP$AMPacket$source(arg_0x7eb33030)
# 88 "ADSenRFNodeP.nc"
static inline  message_t *ADSenRFNodeP$Receive$receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  ADSenRFNodeP$dest_address = ADSenRFNodeP$AMPacket$source(msg);
  ADSenRFNodeP$sensorDataTask$postTask();
}

# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
#define RfReliableMacReceiveP$0$Receive$receive(arg_0x7eb43010,arg_0x7eb431b0,arg_0x7eb43338) ADSenRFNodeP$Receive$receive(arg_0x7eb43010, arg_0x7eb431b0, arg_0x7eb43338)
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$0$AMPacket$source(arg_0x7eb33030) RfPacketP$AMPacket$source(arg_0x7eb33030)
...
# 4 "/opt/atos/tos/lib/atos/utils/DsnFilter.nc"
#define RfReliableMacReceiveP$0$DsnFilter$filter(arg_0x7e408ba8,arg_0x7e408d30) DsnFilterCenterP$0$DsnFilter$filter(0U, arg_0x7e408ba8, arg_0x7e408d30)
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$0$AMPacket$setDestination(arg_0x7eb335f8,arg_0x7eb33788) RfPacketP$AMPacket$setDestination(arg_0x7eb335f8, arg_0x7eb33788)
...
# 166 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$0$AMPacket$group(arg_0x7eb31d08) RfPacketP$AMPacket$group(arg_0x7eb31d08)
...
#define RfReliableMacReceiveP$0$AMPacket$setGroup(arg_0x7eb25558,arg_0x7eb256e8) RfPacketP$AMPacket$setGroup(arg_0x7eb25558, arg_0x7eb256e8)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
#define RfReliableMacReceiveP$0$RfReliableMacAck$fillAckMessage(arg_0x7e6b1850,arg_0x7e6b19e0,arg_0x7e6b1b90,arg_0x7e6b1d40) RfReliableMacAckP$RfReliableMacAck$fillAckMessage(arg_0x7e6b1850, arg_0x7e6b19e0, arg_0x7e6b1b90, arg_0x7e6b1d40)
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacReceiveP$0$SubPacket$getPayload(arg_0x7eb20840,arg_0x7eb209e8) RfPacketP$Packet$getPayload(arg_0x7eb20840, arg_0x7eb209e8)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacReceiveP$0$PacketEx$getPacketHeader(arg_0x7e714ca0) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e714ca0)


#define RfReliableMacReceiveP$0$PacketEx$isValidPacket(arg_0x7e713190) RfReliableMacPacketP$PacketEx$isValidPacket(arg_0x7e713190)
# 57 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacReceiveP.nc"
static inline  message_t */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubReceive$receive(message_t *msg, void *payload, uint8_t len)
{
  if (/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$PacketEx$isValidPacket(msg)) 
    {
      rf_rmac_header_t *header = /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$PacketEx$getPacketHeader(msg);
      rf_ack_t *ack_header = (rf_ack_t *)/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubPacket$getPayload(&/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg, (void *)0);
      ...
      if (header->ack_req) 
        {
          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$RfReliableMacAck$fillAckMessage(msg, header->dsn, &/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg, ack_header);

          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$setGroup(&/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg, /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$group(msg));

          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$setDestination(&/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg, /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$source(msg));

          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$postTask();
        }


      if (!/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$DsnFilter$filter(/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$source(msg), header->dsn)) 
        {
          return msg;
        }

      return /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$Receive$receive(msg, payload, len);
    }
...
#define AtosNetStdP$AtosNetStd$receivedTraceAck(arg_0x7e3741f8,arg_0x7e3743b8) AtosNetStdP$AtosNetStd$default$receivedTraceAck(arg_0x7e3741f8, arg_0x7e3743b8)
...
#define AtosNetStdP$AtosNetStd$receivedTrace(arg_0x7e376b58,arg_0x7e376d08) AtosNetStdP$AtosNetStd$default$receivedTrace(arg_0x7e376b58, arg_0x7e376d08)
...
# 17 "/opt/atos/tos/lib/atos/net/AtosNetStd/AtosNetStd.nc"
#define AtosNetStdP$AtosNetStd$receivedReboot(arg_0x7e3766a8) AtosNetStdP$AtosNetStd$default$receivedReboot(arg_0x7e3766a8)
...
# 8 "/opt/atos/tos/platforms/antc5/devices/FlashIEEE.nc"
#define AtosNetStdP$FlashIEEE$WriteIEEE(arg_0x7ea553d8) FlashIEEEP$FlashIEEE$WriteIEEE(arg_0x7ea553d8)
...
#define AtosNetStdP$AtosNetStd$receivedSetIEEE(arg_0x7e3761f8) AtosNetStdP$AtosNetStd$default$receivedSetIEEE(arg_0x7e3761f8)
...
#define AtosNetStdP$AtosNetStd$receivedDiscovery(arg_0x7e377d20) AtosNetStdP$AtosNetStd$default$receivedDiscovery(arg_0x7e377d20)
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define AtosNetStdP$AMPacket$source(arg_0x7eb33030) RfPacketP$AMPacket$source(arg_0x7eb33030)
...
#define AtosNetStdP$AtosNetStd$receivedNodeStatusUp(arg_0x7e377698,arg_0x7e377850) AtosNetStdP$AtosNetStd$default$receivedNodeStatusUp(arg_0x7e377698, arg_0x7e377850)
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
#define RfReliableMacReceiveP$1$Receive$receive(arg_0x7eb43010,arg_0x7eb431b0,arg_0x7eb43338) AtosNetStdP$Receive$receive(arg_0x7eb43010, arg_0x7eb431b0, arg_0x7eb43338)
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$1$AMPacket$source(arg_0x7eb33030) RfPacketP$AMPacket$source(arg_0x7eb33030)
# 4 "/opt/atos/tos/lib/atos/utils/DsnFilter.nc"
#define RfReliableMacReceiveP$1$DsnFilter$filter(arg_0x7e408ba8,arg_0x7e408d30) DsnFilterCenterP$0$DsnFilter$filter(0U, arg_0x7e408ba8, arg_0x7e408d30)
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$1$AMPacket$setDestination(arg_0x7eb335f8,arg_0x7eb33788) RfPacketP$AMPacket$setDestination(arg_0x7eb335f8, arg_0x7eb33788)
#line 166
#define RfReliableMacReceiveP$1$AMPacket$group(arg_0x7eb31d08) RfPacketP$AMPacket$group(arg_0x7eb31d08)
...
#define RfReliableMacReceiveP$1$AMPacket$setGroup(arg_0x7eb25558,arg_0x7eb256e8) RfPacketP$AMPacket$setGroup(arg_0x7eb25558, arg_0x7eb256e8)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
#define RfReliableMacReceiveP$1$RfReliableMacAck$fillAckMessage(arg_0x7e6b1850,arg_0x7e6b19e0,arg_0x7e6b1b90,arg_0x7e6b1d40) RfReliableMacAckP$RfReliableMacAck$fillAckMessage(arg_0x7e6b1850, arg_0x7e6b19e0, arg_0x7e6b1b90, arg_0x7e6b1d40)
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacReceiveP$1$SubPacket$getPayload(arg_0x7eb20840,arg_0x7eb209e8) RfPacketP$Packet$getPayload(arg_0x7eb20840, arg_0x7eb209e8)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacReceiveP$1$PacketEx$getPacketHeader(arg_0x7e714ca0) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e714ca0)


#define RfReliableMacReceiveP$1$PacketEx$isValidPacket(arg_0x7e713190) RfReliableMacPacketP$PacketEx$isValidPacket(arg_0x7e713190)
# 57 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacReceiveP.nc"
static inline  message_t */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$SubReceive$receive(message_t *msg, void *payload, uint8_t len)
{
...
#define RfReliableMacAckP$RfReliableMacAckEvent$receiveAckMessage(arg_0x7e428508,arg_0x7e4286b8,arg_0x7e428868) RfReliableMacAckP$RfReliableMacAckEvent$default$receiveAckMessage(arg_0x7e428508, arg_0x7e4286b8, arg_0x7e428868)
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
#define RfReliableMacSendP$1$RfReliableMacAck$receiveAckMessage(arg_0x7e6b0238,arg_0x7e6b03e8,arg_0x7e6b0598) RfReliableMacAckP$RfReliableMacAck$receiveAckMessage(arg_0x7e6b0238, arg_0x7e6b03e8, arg_0x7e6b0598)
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacSendP$1$AMPacket$source(arg_0x7eb33030) RfPacketP$AMPacket$source(arg_0x7eb33030)
#line 67
#define RfReliableMacSendP$1$AMPacket$destination(arg_0x7eb35a28) RfPacketP$AMPacket$destination(arg_0x7eb35a28)
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
#define RfReliableMacSendP$0$RfReliableMacAck$receiveAckMessage(arg_0x7e6b0238,arg_0x7e6b03e8,arg_0x7e6b0598) RfReliableMacAckP$RfReliableMacAck$receiveAckMessage(arg_0x7e6b0238, arg_0x7e6b03e8, arg_0x7e6b0598)
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacSendP$0$AMPacket$source(arg_0x7eb33030) RfPacketP$AMPacket$source(arg_0x7eb33030)
#line 67
#define RfReliableMacSendP$0$AMPacket$destination(arg_0x7eb35a28) RfPacketP$AMPacket$destination(arg_0x7eb35a28)
# 158 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
static inline  message_t */*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$ReceiveAck$receive(message_t *ack_msg, void *payload, uint8_t len)
{
  if (/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending) 
    {
      rf_metadata_t *metadata = (rf_metadata_t *)/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg->metadata;
      rf_rmac_header_t *header = /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$PacketEx$getPacketHeader(/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg);
...
#line 169
      header->ack_req
       && header->dsn == __nesc_ntoh_uint8((unsigned char *)&ack_header->dsn)
       && /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$source(ack_msg) == /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$destination(/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg)
       && /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$destination(ack_msg) == /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$source(/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg)) 

        {
          ...
          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$RfReliableMacAck$receiveAckMessage(/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg, ack_msg, ack_header);


          /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDone(/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg, 0);
        }
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static  message_t *RfActiveMessageP$Receive$receive(uint8_t arg_0x7e3d63f8, message_t *arg_0x7eb43010, void *arg_0x7eb431b0, uint8_t arg_0x7eb43338){
#line 67
...
#line 67
    case 123:
#line 67
      result = /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubReceive$receive(arg_0x7eb43010, arg_0x7eb431b0, arg_0x7eb43338);
#line 67
      break;
#line 67
    case 124:
#line 67
      result = /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$ReceiveAck$receive(arg_0x7eb43010, arg_0x7eb431b0, arg_0x7eb43338);
#line 67
      break;
#line 67
    case 240U:
#line 67
      result = /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$SubReceive$receive(arg_0x7eb43010, arg_0x7eb431b0, arg_0x7eb43338);
#line 67
      break;
#line 67
    case 241:
#line 67
      result = /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$ReceiveAck$receive(arg_0x7eb43010, arg_0x7eb431b0, arg_0x7eb43338);
#line 67
      break;
#line 67
    default:
#line 67
      result = RfActiveMessageP$Receive$default$receive(arg_0x7e3d63f8, arg_0x7eb43010, arg_0x7eb431b0, arg_0x7eb43338);
#line 67
      break;
#line 67
    }
...
#define RfActiveMessageP$AMPacket$isForMe(arg_0x7eb327d8) RfPacketP$AMPacket$isForMe(arg_0x7eb327d8)
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfActiveMessageP$Packet$getPayload(arg_0x7eb20840,arg_0x7eb209e8) RfPacketP$Packet$getPayload(arg_0x7eb20840, arg_0x7eb209e8)
...
# 136 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfActiveMessageP$AMPacket$type(arg_0x7eb32f08) RfPacketP$AMPacket$type(arg_0x7eb32f08)
...
# 8 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfActiveMessageP$PacketEx$isValidPacket(arg_0x7e713190) RfPacketP$PacketEx$isValidPacket(arg_0x7e713190)
# 20 "/opt/atos/tos/lib/atos/net/AtosMac/AM/RfActiveMessageP.nc"
static inline  void RfActiveMessageP$CoreReceive$receive(message_t *msg)
{
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreReceive.nc"
#define RfMacBaseReceiveP$CoreReceive$receive(arg_0x7e3d1030) RfActiveMessageP$CoreReceive$receive(arg_0x7e3d1030)
# 12 "/opt/atos/tos/lib/atos/net/AtosMac/macbase/RfMacBaseReceiveP.nc"
static inline  void RfMacBaseReceiveP$RfHardwareRx$rxPacket(uint8_t *buf, uint8_t len)
{
...
# 5 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/RfHardwareRx.nc"
#define RfHardwareRxP$0$RfHardwareRx$rxPacket(arg_0x7e582570,arg_0x7e5826f8) RfMacBaseReceiveP$RfHardwareRx$rxPacket(arg_0x7e582570, arg_0x7e5826f8)
...
# 8 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacPacketP$SubPacketEx$isValidPacket(arg_0x7e713190) RfPacketP$PacketEx$isValidPacket(arg_0x7e713190)
...
# 4 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAckEvent.nc"
#define RfReliableMacAckP$RfReliableMacAckEvent$fillAckMessage(arg_0x7e42bb10,arg_0x7e42bca0,arg_0x7e42be50,arg_0x7e428030) RfReliableMacAckP$RfReliableMacAckEvent$default$fillAckMessage(arg_0x7e42bb10, arg_0x7e42bca0, arg_0x7e42be50, arg_0x7e428030)
...
# 50 "/opt/tinyos-2.x/tos/interfaces/GpioCapture.nc"
#define HplCC2530Timer1P$0$CaptureChannel2$captured(arg_0x7e937ba0) HplCC2530Timer1P$0$CaptureChannel2$default$captured(arg_0x7e937ba0)
...
#line 64
    case ADSenRFNodeP$sensorDataTask:
#line 64
      ADSenRFNodeP$sensorDataTask$runTask();
#line 64
      break;
#line 64
    case ADSenRFNodeP$sendMsgTask:
#line 64
      ADSenRFNodeP$sendMsgTask$runTask();
#line 64
      break;
#line 64
...
#line 64
      break;
#line 64
    case /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask:
#line 64
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$runTask();
#line 64
      break;
#line 64
    case /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask:
#line 64
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$runTask();
#line 64
      break;
#line 64
...
#line 64
      break;
#line 64
    case /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask:
#line 64
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$runTask();
#line 64
      break;
#line 64
...
#line 67
  result = RfReliableMacPacketP$Packet$payloadLength(arg_0x7eb21468);
#line 67
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  void AMResourceCenterP$AMResource$sendDone(uint8_t arg_0x7e6476f0, message_t *arg_0x7e662a60, error_t arg_0x7e662be8){
#line 7
  switch (arg_0x7e6476f0) {
#line 7
    case /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC*/AMResourceC$0$AM_RESOURCE_ID:
#line 7
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$sendDone(arg_0x7e662a60, arg_0x7e662be8);
#line 7
      break;
#line 7
    case /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC*/AMResourceC$2$AM_RESOURCE_ID:
#line 7
      /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMResource$sendDone(arg_0x7e662a60, arg_0x7e662be8);
#line 7
      break;
#line 7
    case /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC*/AMResourceC$3$AM_RESOURCE_ID:
#line 7
      /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMResource$sendDone(arg_0x7e662a60, arg_0x7e662be8);
#line 7
      break;
#line 7
    case /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC*/AMResourceC$1$AM_RESOURCE_ID:
#line 7
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$sendDone(arg_0x7e662a60, arg_0x7e662be8);
#line 7
      break;
#line 7
    default:
#line 7
      AMResourceCenterP$AMResource$default$sendDone(arg_0x7e6476f0, arg_0x7e662a60, arg_0x7e662be8);
#line 7
      break;
#line 7
    }
...
#line 57
      ...
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg = msg;
      /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_result = result;
    }
#line 66
    __nesc_atomic_end(__nesc_atomic); }

  /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$postTask();
}
...
#line 33
  ...
  /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMSend$sendDone(msg, result);
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 38
    /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_sending = FALSE;
#line 38
...
static error_t /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$doSend(message_t *msg)
{
  return /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAMSend$send(/*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMPacket$destination(msg), msg, /*ADSenRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$Packet$payloadLength(msg));
}
...
#line 69
  ...
  memcpy(ADSenRFNodeP$p_sensor_payload, sensor_payload, 2);

  if (result == 0) 
    {
      ADSenRFNodeP$sendMsgTask$postTask();
    }
  else 
    {
      ADSenRFNodeP$sensorDataTask$postTask();

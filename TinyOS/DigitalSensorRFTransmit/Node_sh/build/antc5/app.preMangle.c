...
# 10 "/opt/atos/tos/lib/atos/sensor/drv/DS18B20/DS18B20.h"
#line 6
...
# 39 "/opt/atos/tos/lib/atos/devices/gps/common/GpsData.h"
#line 17
...
gps_data_t;
# 245 "/opt/atos/tos/lib/atos/sensor/SensorCollection.h"
#line 241
typedef struct _sensor_id_t {
...
typedef TMilli DigRFNodeP$Timer1$precision_tag;
typedef TMilli SHTP$WaitTimer$precision_tag;
typedef TMilli RealMainP$FakeTimer$precision_tag;
enum HplCC2530Timer1C$__nesc_unnamed4284 {
...
enum /*HilTimerMilliC.AlarmMilli32C.AlarmFrom*/Alarm32khz16C$0$__nesc_unnamed4285 {
...
typedef TMilli /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$precision_tag;
typedef TMilli /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$precision_tag;
enum /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC*/AMResourceC$0$__nesc_unnamed4286 {
...
enum /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC*/AMResourceC$1$__nesc_unnamed4293 {
  AMResourceC$1$AM_RESOURCE_ID = 3U
};
# 4 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHT.nc"
static  void DigRFNodeP$SHT$readDone(error_t arg_0x7eb73d70, uint16_t arg_0x7eb73f08, uint16_t arg_0x7eb650b8);
# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
static  void DigRFNodeP$Boot$booted(void);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void DigRFNodeP$AMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void DigRFNodeP$Timer1$fired(void);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t *DigRFNodeP$Receive$receive(message_t *arg_0x7eb45740, void *arg_0x7eb458e0, uint8_t arg_0x7eb45a68);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static  void DigRFNodeP$sensorDataTask$runTask(void);
#line 64
static  void DigRFNodeP$sendMsgTask$runTask(void);
# 5 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHT.nc"
static  void SHTP$SHT$calcRealValue(float *arg_0x7eb65570, float *arg_0x7eb65718, uint16_t arg_0x7eb658b0, uint16_t arg_0x7eb65a48);
#line 3
static  error_t SHTP$SHT$read(void);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
static  error_t SHTP$Init$init(void);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void SHTP$WaitTimer$fired(void);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static  void SHTP$readDoneTask$runTask(void);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
static  void FlashIEEEP$FlashIEEE$WriteIEEE(uint8_t *arg_0x7ea013d8);
#line 5
static  uint16_t FlashIEEEP$FlashIEEE$GetShortAddress(void);

static  void FlashIEEEP$FlashIEEE$GetIEEE(uint8_t *arg_0x7ea02f08);
...
#line 43
static   void ActiveMessageAddressC$ActiveMessageAddress$setAddress(am_group_t arg_0x7e9f3e58, am_addr_t arg_0x7e9e6010);
# 3 "/opt/atos/tos/chips/cc2530/flash/HalFlash.nc"
static  error_t HalFlashP$HalFlash$read(uint8_t *arg_0x7e9e3190, uint32_t arg_0x7e9e3320, uint16_t arg_0x7e9e34b0);



static  error_t HalFlashP$HalFlash$erase(uint32_t arg_0x7e9e1170);
#line 5
static  error_t HalFlashP$HalFlash$write(uint32_t arg_0x7e9e3958, uint8_t *arg_0x7e9e3b00, uint16_t arg_0x7e9e3c90);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
static   void /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$CaptureChannel2$default$captured(uint16_t arg_0x7e8e7ba0);
# 92 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
static   void /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm0$startAt(/*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm0$size_type arg_0x7e920e78, /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm0$size_type arg_0x7e917030);
#line 62
...
# 92 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
static   void /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm1$startAt(/*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm1$size_type arg_0x7e920e78, /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$Alarm1$size_type arg_0x7e917030);
#line 62
...
#line 4
static  void PlatformInterruptC$INT_UART0_TX$default$fired(void);
#line 4
...
#line 4
static  void PlatformInterruptC$INT_UART0_RX$default$fired(void);
...
#line 92
static   void /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$Alarm$startAt(/*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$Alarm$size_type arg_0x7e920e78, /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$Alarm$size_type arg_0x7e917030);
#line 105
...
#line 118
static  void /*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$Timer$startOneShotAt(uint32_t arg_0x7eb05120, uint32_t arg_0x7eb052b0);
#line 67
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$runTask(void);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AtosControl$start(void);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubAMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
#line 69
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$fired(void);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$runTask(void);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$fired(void);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AtosControl$start(void);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$ReceiveAck$receive(message_t *arg_0x7eb45740, void *arg_0x7eb458e0, uint8_t arg_0x7eb45a68);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$sendDone(message_t *arg_0x7e6460a8, error_t arg_0x7e646230);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
...
uint8_t arg_0x7e631dd8, 
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
am_addr_t arg_0x7e647888, message_t *arg_0x7e647a38, uint8_t arg_0x7e647bc0);
static  void AMResourceCenterP$AMResource$default$sendDone(
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceCenterP.nc"
uint8_t arg_0x7e631dd8, 
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
message_t *arg_0x7e6460a8, error_t arg_0x7e646230);
# 9 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
static  void AMResourceCenterP$CoreSend$sendDone(message_t *arg_0x7e6264c0, error_t arg_0x7e626648);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t AMResourceCenterP$AtosControl$start(void);
# 9 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
static  void /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SubCoreSend$sendDone(message_t *arg_0x7e6264c0, error_t arg_0x7e626648);
#line 7
static  error_t /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$CoreSend$send(message_t *arg_0x7e627998, uint8_t arg_0x7e627b20);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
#line 49
static  error_t /*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$enqueue(/*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$t arg_0x7e606930);
...
static  /*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$t /*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$element(uint8_t arg_0x7e606ea8);
...
#line 65
static  /*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$t /*AMResourceCenterC.RfMacBaseSendC.QueueExC*/QueueExC$0$QueueEx$remove(uint8_t arg_0x7e604990);
#line 40
...
static  error_t RfMacBaseCsmaP$CoreSend$send(message_t *arg_0x7e627998, uint8_t arg_0x7e627b20);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
static  error_t RfHardwareTxP$RfHardwareTx$txPrepare(uint8_t *arg_0x7e5a9c98, uint8_t arg_0x7e5a9e20);
...
#line 92
static   void /*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$Alarm$startAt(/*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$Alarm$size_type arg_0x7e920e78, /*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$Alarm$size_type arg_0x7e917030);
#line 55
static   void /*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$Alarm$start(/*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$Alarm$size_type arg_0x7e921d18);
...
static  uint8_t RfPacketP$Packet$payloadLength(message_t *arg_0x7eb23a40);
#line 108
static  void *RfPacketP$Packet$getPayload(message_t *arg_0x7eb21e20, uint8_t *arg_0x7eb20010);
#line 83
static  void RfPacketP$Packet$setPayloadLength(message_t *arg_0x7eb210d0, uint8_t arg_0x7eb21258);
# 58 "/opt/tinyos-2.x/tos/interfaces/ActiveMessageAddress.nc"
static   void RfPacketP$ActiveMessageAddress$changed(void);
# 166 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_group_t RfPacketP$AMPacket$group(message_t *arg_0x7eb31590);
#line 77
static  am_addr_t RfPacketP$AMPacket$source(message_t *arg_0x7eb35688);
#line 57
...
static  am_addr_t RfPacketP$AMPacket$destination(message_t *arg_0x7eb350a8);
#line 110
static  void RfPacketP$AMPacket$setSource(message_t *arg_0x7eb345c8, am_addr_t arg_0x7eb34758);
#line 92
static  void RfPacketP$AMPacket$setDestination(message_t *arg_0x7eb35c50, am_addr_t arg_0x7eb35de0);
#line 136
static  am_id_t RfPacketP$AMPacket$type(message_t *arg_0x7eb32660);
#line 125
static  bool RfPacketP$AMPacket$isForMe(message_t *arg_0x7eb34f00);
#line 176
static  void RfPacketP$AMPacket$setGroup(message_t *arg_0x7eb31c20, am_group_t arg_0x7eb31db0);
...
static  bool RfPacketP$PacketEx$isValidPacket(message_t *arg_0x7e6f74e8);
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t RfReliableMacPacketP$Packet$payloadLength(message_t *arg_0x7eb23a40);
#line 108
static  void *RfReliableMacPacketP$Packet$getPayload(message_t *arg_0x7eb21e20, uint8_t *arg_0x7eb20010);
#line 83
static  void RfReliableMacPacketP$Packet$setPayloadLength(message_t *arg_0x7eb210d0, uint8_t arg_0x7eb21258);
# 5 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  uint8_t RfReliableMacPacketP$PacketEx$packetHeaderSize(void);
static  void *RfReliableMacPacketP$PacketEx$getPacketHeader(message_t *arg_0x7e6f7010);

static  bool RfReliableMacPacketP$PacketEx$isValidPacket(message_t *arg_0x7e6f74e8);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
static  uint8_t RfReliableMacAckP$RfReliableMacAck$fillAckMessage(message_t *arg_0x7e695b48, uint8_t arg_0x7e695cd8, message_t *arg_0x7e695e88, rf_ack_t *arg_0x7e694068);
static  void RfReliableMacAckP$RfReliableMacAck$receiveAckMessage(message_t *arg_0x7e694540, message_t *arg_0x7e6946f0, rf_ack_t *arg_0x7e6948a0);
# 4 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAckEvent.nc"
static  uint8_t RfReliableMacAckP$RfReliableMacAckEvent$default$fillAckMessage(message_t *arg_0x7e415968, uint8_t arg_0x7e415af8, message_t *arg_0x7e415ca8, rf_ack_t *arg_0x7e415e58);
static  void RfReliableMacAckP$RfReliableMacAckEvent$default$receiveAckMessage(message_t *arg_0x7e414368, message_t *arg_0x7e414518, rf_ack_t *arg_0x7e4146c8);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubReceive$receive(message_t *arg_0x7eb45740, void *arg_0x7eb458e0, uint8_t arg_0x7eb45a68);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$runTask(void);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMSendAck$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AtosControl$start(void);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreReceive.nc"
static  void RfActiveMessageP$CoreReceive$receive(message_t *arg_0x7e3be030);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t *RfActiveMessageP$Snoop$default$receive(
# 8 "/opt/atos/tos/lib/atos/net/AtosMac/AM/RfActiveMessageP.nc"
uint8_t arg_0x7e3c3bb0, 
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
message_t *arg_0x7eb45740, void *arg_0x7eb458e0, uint8_t arg_0x7eb45a68);
#line 67
static  message_t *RfActiveMessageP$Receive$default$receive(
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/RfActiveMessageP.nc"
uint8_t arg_0x7e3c33f8, 
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
message_t *arg_0x7eb45740, void *arg_0x7eb458e0, uint8_t arg_0x7eb45a68);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t RfActiveMessageP$AtosControl$start(void);
# 5 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/RfHardwareRx.nc"
static  void RfMacBaseReceiveP$RfHardwareRx$rxPacket(uint8_t *arg_0x7e56b7e8, uint8_t arg_0x7e56b970);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t AtosMacP$AtosControl$start(void);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void AtosNetStdP$AMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t *AtosNetStdP$Receive$receive(message_t *arg_0x7eb45740, void *arg_0x7eb458e0, uint8_t arg_0x7eb45a68);
# 17 "/opt/atos/tos/lib/atos/net/AtosNetStd/AtosNetStd.nc"
static  void AtosNetStdP$AtosNetStd$default$receivedReboot(anstd_reboot_t *arg_0x7e3546a8);

static  void AtosNetStdP$AtosNetStd$default$receivedTraceAck(message_t *arg_0x7e3521f8, anstd_trace_ack_t *arg_0x7e3523b8);
#line 15
static  void AtosNetStdP$AtosNetStd$default$receivedDiscovery(anstd_discovery_t *arg_0x7e355d20);


static  void AtosNetStdP$AtosNetStd$default$receivedTrace(message_t *arg_0x7e354b58, anstd_trace_t *arg_0x7e354d08);
#line 6
static  error_t AtosNetStdP$AtosNetStd$sendNodeStatusUp(uint16_t arg_0x7e359d68);





static  void AtosNetStdP$AtosNetStd$default$beforeNodeStatusUp(anstd_node_status_t *arg_0x7e3551e0);

static  void AtosNetStdP$AtosNetStd$default$receivedNodeStatusUp(message_t *arg_0x7e355698, anstd_node_status_t *arg_0x7e355850);

static  void AtosNetStdP$AtosNetStd$default$receivedSetIEEE(anstd_setieee_t *arg_0x7e3541f8);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$SubAMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$AMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$SubAMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
#line 69
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$AMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$ReceiveAck$receive(message_t *arg_0x7eb45740, void *arg_0x7eb458e0, uint8_t arg_0x7eb45a68);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMResource$sendDone(message_t *arg_0x7e6460a8, error_t arg_0x7e646230);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$SubReceive$receive(message_t *arg_0x7eb45740, void *arg_0x7eb458e0, uint8_t arg_0x7eb45a68);
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMSendAck$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMResource$sendDone(message_t *arg_0x7e6460a8, error_t arg_0x7e646230);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
...
uint8_t arg_0x7e261dc0, 
# 4 "/opt/atos/tos/lib/atos/utils/DsnFilter.nc"
uint16_t arg_0x7e3f3b78, uint8_t arg_0x7e3f3d00);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
static  error_t /*DsnFilterCenterC.DsnFilterCenterP*/DsnFilterCenterP$0$Init$init(void);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$sendDone(message_t *arg_0x7e6460a8, error_t arg_0x7e646230);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 5 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHT.nc"
static  void DigRFNodeP$SHT$calcRealValue(float *arg_0x7eb65570, float *arg_0x7eb65718, uint16_t arg_0x7eb658b0, uint16_t arg_0x7eb65a48);
#line 3
static  error_t DigRFNodeP$SHT$read(void);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t DigRFNodeP$AMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  void *DigRFNodeP$Packet$getPayload(message_t *arg_0x7eb21e20, uint8_t *arg_0x7eb20010);
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void DigRFNodeP$Timer1$startPeriodic(uint32_t arg_0x7eb13e50);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t DigRFNodeP$sensorDataTask$postTask(void);
#line 56
static   error_t DigRFNodeP$sendMsgTask$postTask(void);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t DigRFNodeP$AtosControl$start(void);
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t DigRFNodeP$AMPacket$source(message_t *arg_0x7eb35688);
# 30 "DigRFNodeP.nc"
enum DigRFNodeP$__nesc_unnamed4294 {
#line 30
  DigRFNodeP$sensorDataTask = 0U
};
#line 30
typedef int DigRFNodeP$__nesc_sillytask_sensorDataTask[DigRFNodeP$sensorDataTask];





enum DigRFNodeP$__nesc_unnamed4295 {
#line 36
  DigRFNodeP$sendMsgTask = 1U
};
#line 36
typedef int DigRFNodeP$__nesc_sillytask_sendMsgTask[DigRFNodeP$sendMsgTask];
#line 23
message_t DigRFNodeP$m_sensor_msg;



uint8_t *DigRFNodeP$p_sensor_payload;
uint16_t DigRFNodeP$dest_address;

static inline  void DigRFNodeP$sensorDataTask$runTask(void);





static inline  void DigRFNodeP$sendMsgTask$runTask(void);
...
static inline  void DigRFNodeP$AMSend$sendDone(message_t *msg, error_t success);
...
static inline  void DigRFNodeP$Boot$booted(void);
#line 64
static inline  void DigRFNodeP$SHT$readDone(error_t result, uint16_t temperature, uint16_t humidity);
#line 90
static inline  message_t *DigRFNodeP$Receive$receive(message_t *msg, void *payload, uint8_t len);
#line 106
static inline  void DigRFNodeP$Timer1$fired(void);
# 4 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHT.nc"
static  void SHTP$SHT$readDone(error_t arg_0x7eb73d70, uint16_t arg_0x7eb73f08, uint16_t arg_0x7eb650b8);
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void SHTP$WaitTimer$startOneShot(uint32_t arg_0x7eb11498);




static  void SHTP$WaitTimer$stop(void);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t SHTP$readDoneTask$postTask(void);
# 47 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHTP.nc"
enum SHTP$__nesc_unnamed4296 {
#line 47
  SHTP$readDoneTask = 2U
};
#line 47
typedef int SHTP$__nesc_sillytask_readDoneTask[SHTP$readDoneTask];
#line 29
enum SHTP$__nesc_unnamed4297 {
...
uint8_t SHTP$m_state = SHTP$SHT_STATE_NONE;

uint8_t SHTP$tick;

uint8_t SHTP$m_error = 0;

uint16_t SHTP$m_temperature;
uint16_t SHTP$m_humidity;
uint8_t SHTP$m_checksum;
uint8_t *SHTP$p_value;



static inline  error_t SHTP$Init$init(void);
...
static uint8_t SHTP$sendByte(uint8_t value);
#line 96
static uint8_t SHTP$recvByte(uint8_t ack);
#line 137
static uint8_t SHTP$start(void);
#line 169
static inline void SHTP$reset(void);
#line 217
static uint8_t SHTP$cmdMeasure(void);
#line 249
static inline  void SHTP$WaitTimer$fired(void);
#line 284
static inline  void SHTP$readDoneTask$runTask(void);
...
static inline  error_t SHTP$SHT$read(void);
#line 322
static inline  void SHTP$SHT$calcRealValue(float *temperature, float *humidity, uint16_t raw_temperatue, uint16_t raw_humidity);
# 51 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
static  void WatchDogP$WatchDog$resetCpu(void);
# 3 "/opt/atos/tos/chips/cc2530/flash/HalFlash.nc"
static  error_t FlashIEEEP$HalFlash$read(uint8_t *arg_0x7e9e3190, uint32_t arg_0x7e9e3320, uint16_t arg_0x7e9e34b0);



static  error_t FlashIEEEP$HalFlash$erase(uint32_t arg_0x7e9e1170);
#line 5
static  error_t FlashIEEEP$HalFlash$write(uint32_t arg_0x7e9e3958, uint8_t *arg_0x7e9e3b00, uint16_t arg_0x7e9e3c90);
# 43 "/opt/tinyos-2.x/tos/interfaces/ActiveMessageAddress.nc"
static   void FlashIEEEP$ActiveMessageAddress$setAddress(am_group_t arg_0x7e9f3e58, am_addr_t arg_0x7e9e6010);
...
enum RealMainP$__nesc_unnamed4298 {
#line 103
  RealMainP$fakeTask = 3U
};
#line 103
...
enum SchedulerBasicP$__nesc_unnamed4299 {
  ...
  SchedulerBasicP$NUM_TASKS = 18U + 1, 
...
enum TopTaskMgrP$__nesc_unnamed4300 {

  TopTaskMgrP$TOP_TASK_COUNT = 2U
};
...
# 50 "/opt/tinyos-2.x/tos/interfaces/GpioCapture.nc"
static   void /*HplCC2530Timer1C.HplCC2530Timer1P*/HplCC2530Timer1P$0$CaptureChannel2$captured(uint16_t arg_0x7e8e7ba0);
# 67 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
...
static inline   void PlatformInterruptC$INT_UART0_RX$default$fired(void);
...
static inline   void PlatformInterruptC$INT_UART0_TX$default$fired(void);
...
enum /*CounterMilli32C.Transform*/TransformCounterC$0$__nesc_unnamed4301 {
...
#line 92
static   void /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$AlarmFrom$startAt(/*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$AlarmFrom$size_type arg_0x7e920e78, /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$AlarmFrom$size_type arg_0x7e917030);
#line 62
...
enum /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$__nesc_unnamed4302 {
...
#line 92
static   void /*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$Alarm$startAt(/*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$Alarm$size_type arg_0x7e920e78, /*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$Alarm$size_type arg_0x7e917030);
#line 105
...
enum /*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$__nesc_unnamed4303 {
#line 81
  AlarmToTimerC$0$firedTask = 4U
};
#line 81
...
#line 118
static  void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$TimerFrom$startOneShotAt(uint32_t arg_0x7eb05120, uint32_t arg_0x7eb052b0);
#line 67
...
#line 48
typedef struct /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$__nesc_unnamed4306 {
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$PacketEx$getPacketHeader(message_t *arg_0x7e6f7010);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$postTask(void);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$Packet$payloadLength(message_t *arg_0x7eb23a40);
#line 83
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$Packet$setPayloadLength(message_t *arg_0x7eb210d0, uint8_t arg_0x7eb21258);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAtosControl$start(void);
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMPacket$destination(message_t *arg_0x7eb350a8);
#line 92
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMPacket$setDestination(message_t *arg_0x7eb35c50, am_addr_t arg_0x7eb35de0);
# 48 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacRetrySendP.nc"
enum /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$__nesc_unnamed4307 {
#line 48
  RfReliableMacRetrySendP$0$resendTask = 6U
};
#line 48
typedef int /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$__nesc_sillytask_resendTask[/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask];
#line 19
uint8_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_sending = FALSE;
message_t */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_msg;
uint8_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_retry_times = 0;


static void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$signalDone(message_t *msg, error_t result);
#line 43
static error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$doSend(message_t *msg);




static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$runTask(void);
#line 74
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len);
#line 129
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAMSend$sendDone(message_t *msg, error_t error);
#line 150
bool /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_started = FALSE;
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AtosControl$start(void);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubAMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$source(message_t *arg_0x7eb35688);
#line 67
static  am_addr_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$destination(message_t *arg_0x7eb350a8);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$PacketEx$getPacketHeader(message_t *arg_0x7e6f7010);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$startOneShot(uint32_t arg_0x7eb11498);




static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$stop(void);
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubPacket$payloadLength(message_t *arg_0x7eb23a40);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$RfReliableMacAck$receiveAckMessage(message_t *arg_0x7e694540, message_t *arg_0x7e6946f0, rf_ack_t *arg_0x7e6948a0);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$postTask(void);
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$startOneShot(uint32_t arg_0x7eb11498);




static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$stop(void);
# 31 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
enum /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$__nesc_unnamed4308 {
#line 31
  RfReliableMacSendP$0$signalDoneTask = 7U
};
#line 31
typedef int /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$__nesc_sillytask_signalDoneTask[/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask];
#line 26
uint8_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending = FALSE;
message_t */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg;
error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_result;


static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$runTask(void);
#line 51
static void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDone(message_t *msg, error_t result);
#line 71
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$fired(void);
...
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$fired(void);
...
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len);
#line 139
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubAMSend$sendDone(message_t *msg, error_t error);
#line 158
static inline  message_t */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$ReceiveAck$receive(message_t *ack_msg, void *payload, uint8_t len);
#line 203
bool /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_started = FALSE;
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AtosControl$start(void);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$send(am_addr_t arg_0x7e647888, message_t *arg_0x7e647a38, uint8_t arg_0x7e647bc0);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len);
#line 39
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$sendDone(message_t *msg, error_t error);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
...
static  void AMResourceCenterP$Packet$setPayloadLength(message_t *arg_0x7eb210d0, uint8_t arg_0x7eb21258);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
static  error_t AMResourceCenterP$SubAtosControl$start(void);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
static  error_t AMResourceCenterP$CoreSend$send(message_t *arg_0x7e627998, uint8_t arg_0x7e627b20);
# 57 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t AMResourceCenterP$AMPacket$address(void);
#line 110
static  void AMResourceCenterP$AMPacket$setSource(message_t *arg_0x7eb345c8, am_addr_t arg_0x7eb34758);
#line 92
static  void AMResourceCenterP$AMPacket$setDestination(message_t *arg_0x7eb35c50, am_addr_t arg_0x7eb35de0);
#line 176
static  void AMResourceCenterP$AMPacket$setGroup(message_t *arg_0x7eb31c20, am_group_t arg_0x7eb31db0);
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
static  error_t /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SubCoreSend$send(message_t *arg_0x7e627998, uint8_t arg_0x7e627b20);
# 41 "/opt/tinyos-2.x/tos/interfaces/Random.nc"
...
static  error_t /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SendQueue$enqueue(/*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SendQueue$t arg_0x7e606930);
...
static  /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SendQueue$t /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$SendQueue$element(uint8_t arg_0x7e606ea8);
...
# 9 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
static  void /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$CoreSend$sendDone(message_t *arg_0x7e6264c0, error_t arg_0x7e626648);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
enum /*AMResourceCenterC.RfMacBaseSendC.RfMacBaseSendP*/RfMacBaseSendP$0$__nesc_unnamed4309 {
#line 23
  RfMacBaseSendP$0$sendNext = 8U
};
#line 23
...
# 4 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/RfHardwareTx.nc"
static  error_t RfMacBaseCsmaP$RfHardwareTx$txPrepare(uint8_t *arg_0x7e5a9c98, uint8_t arg_0x7e5a9e20);
static  error_t RfMacBaseCsmaP$RfHardwareTx$txGo(void);
# 55 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
static   void RfMacBaseCsmaP$BackoffTimer$start(RfMacBaseCsmaP$BackoffTimer$size_type arg_0x7e921d18);
...
# 9 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
static  void RfMacBaseCsmaP$CoreSend$sendDone(message_t *arg_0x7e6264c0, error_t arg_0x7e626648);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
enum RfMacBaseCsmaP$__nesc_unnamed4313 {
...
# 5 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/RfHardwareRx.nc"
static  void /*RfHardwareRxC.RfHardwareRxP*/RfHardwareRxP$0$RfHardwareRx$rxPacket(uint8_t *arg_0x7e56b7e8, uint8_t arg_0x7e56b970);
# 42 "/opt/tinyos-2.x/tos/interfaces/GpioInterrupt.nc"
...
#line 92
static   void /*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$AlarmFrom$startAt(/*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$AlarmFrom$size_type arg_0x7e920e78, /*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$AlarmFrom$size_type arg_0x7e917030);
#line 62
...
enum /*RfMacBaseCsmaC.Alarm32khz32C.Transform*/TransformAlarmC$1$__nesc_unnamed4314 {
...
enum /*Counter32khz32C.TransformCounterC*/TransformCounterC$1$__nesc_unnamed4315 {
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t RfReliableMacPacketP$SubPacket$payloadLength(message_t *arg_0x7eb23a40);
#line 108
static  void *RfReliableMacPacketP$SubPacket$getPayload(message_t *arg_0x7eb21e20, uint8_t *arg_0x7eb20010);
#line 83
static  void RfReliableMacPacketP$SubPacket$setPayloadLength(message_t *arg_0x7eb210d0, uint8_t arg_0x7eb21258);
# 8 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  bool RfReliableMacPacketP$SubPacketEx$isValidPacket(message_t *arg_0x7e6f74e8);
...
# 4 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAckEvent.nc"
static  uint8_t RfReliableMacAckP$RfReliableMacAckEvent$fillAckMessage(message_t *arg_0x7e415968, uint8_t arg_0x7e415af8, message_t *arg_0x7e415ca8, rf_ack_t *arg_0x7e415e58);
static  void RfReliableMacAckP$RfReliableMacAckEvent$receiveAckMessage(message_t *arg_0x7e414368, message_t *arg_0x7e414518, rf_ack_t *arg_0x7e4146c8);
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$PacketEx$getPacketHeader(message_t *arg_0x7e6f7010);

static  bool /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$PacketEx$isValidPacket(message_t *arg_0x7e6f74e8);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
static  uint8_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$RfReliableMacAck$fillAckMessage(message_t *arg_0x7e695b48, uint8_t arg_0x7e695cd8, message_t *arg_0x7e695e88, rf_ack_t *arg_0x7e694068);
# 4 "/opt/atos/tos/lib/atos/utils/DsnFilter.nc"
static  bool /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$DsnFilter$filter(uint16_t arg_0x7e3f3b78, uint8_t arg_0x7e3f3d00);
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  void */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubPacket$getPayload(message_t *arg_0x7eb21e20, uint8_t *arg_0x7eb20010);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$postTask(void);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$Receive$receive(message_t *arg_0x7eb45740, void *arg_0x7eb458e0, uint8_t arg_0x7eb45a68);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMSendAck$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 166 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_group_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$group(message_t *arg_0x7eb31590);
#line 77
static  am_addr_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$source(message_t *arg_0x7eb35688);
#line 67
static  am_addr_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$destination(message_t *arg_0x7eb350a8);
#line 92
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$setDestination(message_t *arg_0x7eb35c50, am_addr_t arg_0x7eb35de0);
#line 176
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$setGroup(message_t *arg_0x7eb31c20, am_group_t arg_0x7eb31db0);
# 47 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacReceiveP.nc"
enum /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$__nesc_unnamed4316 {
#line 47
  RfReliableMacReceiveP$0$sendAckTask = 11U
};
#line 47
typedef int /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$__nesc_sillytask_sendAckTask[/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask];
#line 37
message_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg;

static inline void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAck(message_t *msg);
...
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$runTask(void);




static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMSendAck$sendDone(message_t *msg, error_t result);




static inline  message_t */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 100
bool /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_started = FALSE;
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AtosControl$start(void);
# 8 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  bool RfActiveMessageP$PacketEx$isValidPacket(message_t *arg_0x7e6f74e8);
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  void *RfActiveMessageP$Packet$getPayload(message_t *arg_0x7eb21e20, uint8_t *arg_0x7eb20010);
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
...
static  am_id_t RfActiveMessageP$AMPacket$type(message_t *arg_0x7eb32660);
#line 125
static  bool RfActiveMessageP$AMPacket$isForMe(message_t *arg_0x7eb34f00);
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreReceive.nc"
static  void RfMacBaseReceiveP$CoreReceive$receive(message_t *arg_0x7e3be030);
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t AtosNetStdP$Packet$payloadLength(message_t *arg_0x7eb23a40);
#line 108
static  void *AtosNetStdP$Packet$getPayload(message_t *arg_0x7eb21e20, uint8_t *arg_0x7eb20010);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t AtosNetStdP$AMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 4 "/opt/atos/tos/chips/cc2530/watchdog/WatchDog.nc"
static  void AtosNetStdP$WatchDog$resetCpu(void);
# 17 "/opt/atos/tos/lib/atos/net/AtosNetStd/AtosNetStd.nc"
static  void AtosNetStdP$AtosNetStd$receivedReboot(anstd_reboot_t *arg_0x7e3546a8);

static  void AtosNetStdP$AtosNetStd$receivedTraceAck(message_t *arg_0x7e3521f8, anstd_trace_ack_t *arg_0x7e3523b8);
#line 15
static  void AtosNetStdP$AtosNetStd$receivedDiscovery(anstd_discovery_t *arg_0x7e355d20);


static  void AtosNetStdP$AtosNetStd$receivedTrace(message_t *arg_0x7e354b58, anstd_trace_t *arg_0x7e354d08);
#line 12
static  void AtosNetStdP$AtosNetStd$beforeNodeStatusUp(anstd_node_status_t *arg_0x7e3551e0);

static  void AtosNetStdP$AtosNetStd$receivedNodeStatusUp(message_t *arg_0x7e355698, anstd_node_status_t *arg_0x7e355850);

static  void AtosNetStdP$AtosNetStd$receivedSetIEEE(anstd_setieee_t *arg_0x7e3541f8);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t AtosNetStdP$nodeStatusUpTask$postTask(void);
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void AtosNetStdP$RebootTimer$startPeriodic(uint32_t arg_0x7eb13e50);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static   error_t AtosNetStdP$rebootTask$postTask(void);
# 8 "/opt/atos/tos/platforms/antc5/devices/FlashIEEE.nc"
static  void AtosNetStdP$FlashIEEE$WriteIEEE(uint8_t *arg_0x7ea013d8);
#line 7
static  void AtosNetStdP$FlashIEEE$GetIEEE(uint8_t *arg_0x7ea02f08);
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t AtosNetStdP$AMPacket$source(message_t *arg_0x7eb35688);
#line 57
...
#line 59
  AtosNetStdP$nodeStatusUpTask = 13U
};
#line 59
typedef int AtosNetStdP$__nesc_sillytask_nodeStatusUpTask[AtosNetStdP$nodeStatusUpTask];
#line 350
enum AtosNetStdP$__nesc_unnamed4319 {
#line 350
  AtosNetStdP$sendDoneCheck = 14U
};
#line 350
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$SubAMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$PacketEx$getPacketHeader(message_t *arg_0x7e6f7010);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$AMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$Packet$payloadLength(message_t *arg_0x7eb23a40);
#line 83
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$Packet$setPayloadLength(message_t *arg_0x7eb210d0, uint8_t arg_0x7eb21258);
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
...
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$AMPacket$destination(message_t *arg_0x7eb350a8);
#line 92
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$AMPacket$setDestination(message_t *arg_0x7eb35c50, am_addr_t arg_0x7eb35de0);
# 48 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacRetrySendP.nc"
enum /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$__nesc_unnamed4320 {
#line 48
  RfReliableMacRetrySendP$1$resendTask = 15U
};
#line 48
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$SubAMSend$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_addr_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$AMPacket$source(message_t *arg_0x7eb35688);
#line 67
static  am_addr_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$AMPacket$destination(message_t *arg_0x7eb350a8);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$PacketEx$getPacketHeader(message_t *arg_0x7e6f7010);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$AMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$TimeoutTimer$startOneShot(uint32_t arg_0x7eb11498);
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  uint8_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$SubPacket$payloadLength(message_t *arg_0x7eb23a40);
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$RfReliableMacAck$receiveAckMessage(message_t *arg_0x7e694540, message_t *arg_0x7e6946f0, rf_ack_t *arg_0x7e6948a0);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$AckTimer$startOneShot(uint32_t arg_0x7eb11498);
...
# 31 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
enum /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$__nesc_unnamed4321 {
#line 31
  RfReliableMacSendP$1$signalDoneTask = 16U
};
#line 31
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMResource$send(am_addr_t arg_0x7e647888, message_t *arg_0x7e647a38, uint8_t arg_0x7e647bc0);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
static  void */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$PacketEx$getPacketHeader(message_t *arg_0x7e6f7010);

static  bool /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$PacketEx$isValidPacket(message_t *arg_0x7e6f74e8);
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
static  uint8_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$RfReliableMacAck$fillAckMessage(message_t *arg_0x7e695b48, uint8_t arg_0x7e695cd8, message_t *arg_0x7e695e88, rf_ack_t *arg_0x7e694068);
# 4 "/opt/atos/tos/lib/atos/utils/DsnFilter.nc"
static  bool /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$DsnFilter$filter(uint16_t arg_0x7e3f3b78, uint8_t arg_0x7e3f3d00);
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
static  void */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$SubPacket$getPayload(message_t *arg_0x7eb21e20, uint8_t *arg_0x7eb20010);
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
static  message_t */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$Receive$receive(message_t *arg_0x7eb45740, void *arg_0x7eb458e0, uint8_t arg_0x7eb45a68);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMSendAck$send(am_addr_t arg_0x7eb55590, message_t *arg_0x7eb55740, uint8_t arg_0x7eb558c8);
# 166 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
static  am_group_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMPacket$group(message_t *arg_0x7eb31590);
#line 77
static  am_addr_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMPacket$source(message_t *arg_0x7eb35688);
#line 67
static  am_addr_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMPacket$destination(message_t *arg_0x7eb350a8);
#line 92
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMPacket$setDestination(message_t *arg_0x7eb35c50, am_addr_t arg_0x7eb35de0);
#line 176
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$AMPacket$setGroup(message_t *arg_0x7eb31c20, am_group_t arg_0x7eb31db0);
# 47 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacReceiveP.nc"
enum /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$__nesc_unnamed4322 {
#line 47
  RfReliableMacReceiveP$1$sendAckTask = 17U
};
#line 47
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMResource$send(am_addr_t arg_0x7e647888, message_t *arg_0x7e647a38, uint8_t arg_0x7e647bc0);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$send(am_addr_t arg_0x7e647888, message_t *arg_0x7e647a38, uint8_t arg_0x7e647bc0);
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMSend$sendDone(message_t *arg_0x7eb538e0, error_t arg_0x7eb53a68);
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len);
#line 39
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$sendDone(message_t *msg, error_t error);
...
#define FlashIEEEP$HalFlash$write(arg_0x7e9e3958,arg_0x7e9e3b00,arg_0x7e9e3c90) HalFlashP$HalFlash$write(arg_0x7e9e3958, arg_0x7e9e3b00, arg_0x7e9e3c90)


#define FlashIEEEP$HalFlash$erase(arg_0x7e9e1170) HalFlashP$HalFlash$erase(arg_0x7e9e1170)
...
# 3 "/opt/atos/tos/chips/cc2530/flash/HalFlash.nc"
#define FlashIEEEP$HalFlash$read(arg_0x7e9e3190,arg_0x7e9e3320,arg_0x7e9e34b0) HalFlashP$HalFlash$read(arg_0x7e9e3190, arg_0x7e9e3320, arg_0x7e9e34b0)
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ActiveMessageAddress.nc"
#define FlashIEEEP$ActiveMessageAddress$setAddress(arg_0x7e9f3e58,arg_0x7e9e6010) ActiveMessageAddressC$ActiveMessageAddress$setAddress(arg_0x7e9f3e58, arg_0x7e9e6010)
...
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$1$AMPacket$destination(arg_0x7eb350a8) RfPacketP$AMPacket$destination(arg_0x7eb350a8)
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
#define AMResourceP$2$AMResource$send(arg_0x7e647888,arg_0x7e647a38,arg_0x7e647bc0) AMResourceCenterP$AMResource$send(AMResourceC$3$AM_RESOURCE_ID, arg_0x7e647888, arg_0x7e647a38, arg_0x7e647bc0)
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacReceiveP$1$AMSendAck$send(arg_0x7eb55590,arg_0x7eb55740,arg_0x7eb558c8) AMResourceP$2$AMSend$send(arg_0x7eb55590, arg_0x7eb55740, arg_0x7eb558c8)
...
# 83 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define AMResourceCenterP$Packet$setPayloadLength(arg_0x7eb210d0,arg_0x7eb21258) RfPacketP$Packet$setPayloadLength(arg_0x7eb210d0, arg_0x7eb21258)
...
#define AMResourceCenterP$AMPacket$setGroup(arg_0x7eb31c20,arg_0x7eb31db0) RfPacketP$AMPacket$setGroup(arg_0x7eb31c20, arg_0x7eb31db0)
...
#define AMResourceCenterP$AMPacket$setDestination(arg_0x7eb35c50,arg_0x7eb35de0) RfPacketP$AMPacket$setDestination(arg_0x7eb35c50, arg_0x7eb35de0)
...
#define AMResourceCenterP$AMPacket$setSource(arg_0x7eb345c8,arg_0x7eb34758) RfPacketP$AMPacket$setSource(arg_0x7eb345c8, arg_0x7eb34758)
#line 57
...
# 49 "/opt/atos/tos/lib/atos/utils/QueueEx.nc"
#define RfMacBaseSendP$0$SendQueue$enqueue(arg_0x7e606930) QueueExC$0$QueueEx$enqueue(arg_0x7e606930)
#line 60
#define RfMacBaseSendP$0$SendQueue$element(arg_0x7e606ea8) QueueExC$0$QueueEx$element(arg_0x7e606ea8)
#line 17
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
#define AMResourceCenterP$CoreSend$send(arg_0x7e627998,arg_0x7e627b20) RfMacBaseSendP$0$CoreSend$send(arg_0x7e627998, arg_0x7e627b20)
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacSendP$1$AMSend$sendDone(arg_0x7eb538e0,arg_0x7eb53a68) RfReliableMacRetrySendP$1$SubAMSend$sendDone(arg_0x7eb538e0, arg_0x7eb53a68)
# 31 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
static inline  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$signalDoneTask$runTask(void)
{
  message_t *msg;
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacRetrySendP$1$AMSend$sendDone(arg_0x7eb538e0,arg_0x7eb53a68) AtosNetStdP$AMSend$sendDone(arg_0x7eb538e0, arg_0x7eb53a68)
# 48 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacRetrySendP.nc"
static inline  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$1$resendTask$runTask(void)
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define RfReliableMacSendP$1$TimeoutTimer$startOneShot(arg_0x7eb11498) VirtualizeTimerC$0$Timer$startOneShot(5U, arg_0x7eb11498)
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacSendP$1$SubPacket$payloadLength(arg_0x7eb23a40) RfPacketP$Packet$payloadLength(arg_0x7eb23a40)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
#define AMResourceP$1$AMResource$send(arg_0x7e647888,arg_0x7e647a38,arg_0x7e647bc0) AMResourceCenterP$AMResource$send(AMResourceC$2$AM_RESOURCE_ID, arg_0x7e647888, arg_0x7e647a38, arg_0x7e647bc0)
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
  /* atomic removed: atomic calls only */
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacSendP$1$SubAMSend$send(arg_0x7eb55590,arg_0x7eb55740,arg_0x7eb558c8) AMResourceP$1$AMSend$send(arg_0x7eb55590, arg_0x7eb55740, arg_0x7eb558c8)
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacPacketP$SubPacket$getPayload(arg_0x7eb21e20,arg_0x7eb20010) RfPacketP$Packet$getPayload(arg_0x7eb21e20, arg_0x7eb20010)
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacSendP$1$PacketEx$getPacketHeader(arg_0x7e6f7010) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e6f7010)
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacRetrySendP$1$SubAMSend$send(arg_0x7eb55590,arg_0x7eb55740,arg_0x7eb558c8) RfReliableMacSendP$1$AMSend$send(arg_0x7eb55590, arg_0x7eb55740, arg_0x7eb558c8)
...
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacRetrySendP$1$AMPacket$destination(arg_0x7eb350a8) RfPacketP$AMPacket$destination(arg_0x7eb350a8)
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacPacketP$SubPacket$payloadLength(arg_0x7eb23a40) RfPacketP$Packet$payloadLength(arg_0x7eb23a40)
# 20 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacPacketP.nc"
static inline  uint8_t RfReliableMacPacketP$Packet$payloadLength(message_t *msg)
{
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacRetrySendP$1$Packet$payloadLength(arg_0x7eb23a40) RfReliableMacPacketP$Packet$payloadLength(arg_0x7eb23a40)
# 57 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
...
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define AtosNetStdP$Packet$getPayload(arg_0x7eb21e20,arg_0x7eb20010) RfReliableMacPacketP$Packet$getPayload(arg_0x7eb21e20, arg_0x7eb20010)
...
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacRetrySendP$1$PacketEx$getPacketHeader(arg_0x7e6f7010) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e6f7010)
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacRetrySendP$1$AMPacket$setDestination(arg_0x7eb35c50,arg_0x7eb35de0) RfPacketP$AMPacket$setDestination(arg_0x7eb35c50, arg_0x7eb35de0)
# 83 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacPacketP$SubPacket$setPayloadLength(arg_0x7eb210d0,arg_0x7eb21258) RfPacketP$Packet$setPayloadLength(arg_0x7eb210d0, arg_0x7eb21258)
...
# 83 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacRetrySendP$1$Packet$setPayloadLength(arg_0x7eb210d0,arg_0x7eb21258) RfReliableMacPacketP$Packet$setPayloadLength(arg_0x7eb210d0, arg_0x7eb21258)
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define AtosNetStdP$AMSend$send(arg_0x7eb55590,arg_0x7eb55740,arg_0x7eb558c8) RfReliableMacRetrySendP$1$AMSend$send(arg_0x7eb55590, arg_0x7eb55740, arg_0x7eb558c8)
...
#define AtosNetStdP$AtosNetStd$beforeNodeStatusUp(arg_0x7e3551e0) AtosNetStdP$AtosNetStd$default$beforeNodeStatusUp(arg_0x7e3551e0)
...
# 7 "/opt/atos/tos/platforms/antc5/devices/FlashIEEE.nc"
#define AtosNetStdP$FlashIEEE$GetIEEE(arg_0x7ea02f08) FlashIEEEP$FlashIEEE$GetIEEE(arg_0x7ea02f08)
...
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define AtosNetStdP$RebootTimer$startPeriodic(arg_0x7eb13e50) VirtualizeTimerC$0$Timer$startPeriodic(6U, arg_0x7eb13e50)
# 54 "/opt/atos/tos/lib/atos/net/AtosNetStd/AtosNetStdP.nc"
static inline  void AtosNetStdP$rebootTask$runTask(void)
{
...
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$0$AMPacket$destination(arg_0x7eb350a8) RfPacketP$AMPacket$destination(arg_0x7eb350a8)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
#define AMResourceP$3$AMResource$send(arg_0x7e647888,arg_0x7e647a38,arg_0x7e647bc0) AMResourceCenterP$AMResource$send(AMResourceC$1$AM_RESOURCE_ID, arg_0x7e647888, arg_0x7e647a38, arg_0x7e647bc0)
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
#line 17
  ...
  return /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$send(addr, msg, len);
}

# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacReceiveP$0$AMSendAck$send(arg_0x7eb55590,arg_0x7eb55740,arg_0x7eb558c8) AMResourceP$3$AMSend$send(arg_0x7eb55590, arg_0x7eb55740, arg_0x7eb558c8)
# 39 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacReceiveP.nc"
static inline void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAck(message_t *msg)
{
  if (/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMSendAck$send(/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$destination(msg), msg, sizeof(rf_ack_t )) != 0) 
    {
    }
}
...
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$runTask(void)
{
  /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAck(&/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg);
}
...
# 9 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
#define RfMacBaseSendP$0$CoreSend$sendDone(arg_0x7e6264c0,arg_0x7e626648) AMResourceCenterP$CoreSend$sendDone(arg_0x7e6264c0, arg_0x7e626648)
...
# 9 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
#define RfMacBaseCsmaP$CoreSend$sendDone(arg_0x7e6264c0,arg_0x7e626648) RfMacBaseSendP$0$SubCoreSend$sendDone(arg_0x7e6264c0, arg_0x7e626648)
# 53 "/opt/atos/tos/lib/atos/net/AtosMac/macbase/RfMacBaseCsmaP.nc"
static inline  void RfMacBaseCsmaP$signalDoneTask$runTask(void)
{
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define AMResourceP$3$AMSend$sendDone(arg_0x7eb538e0,arg_0x7eb53a68) RfReliableMacReceiveP$0$AMSendAck$sendDone(arg_0x7eb538e0, arg_0x7eb53a68)
...
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$sendDone(message_t *msg, error_t error)
{
  ...
  /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMSend$sendDone(msg, error);
}
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define AMResourceP$2$AMSend$sendDone(arg_0x7eb538e0,arg_0x7eb53a68) RfReliableMacReceiveP$1$AMSendAck$sendDone(arg_0x7eb538e0, arg_0x7eb53a68)
# 39 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMResource$sendDone(message_t *msg, error_t error)
{
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define RfReliableMacSendP$1$AckTimer$startOneShot(arg_0x7eb11498) VirtualizeTimerC$0$Timer$startOneShot(4U, arg_0x7eb11498)
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define AMResourceP$1$AMSend$sendDone(arg_0x7eb538e0,arg_0x7eb53a68) RfReliableMacSendP$1$SubAMSend$sendDone(arg_0x7eb538e0, arg_0x7eb53a68)
# 39 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  void /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMResource$sendDone(message_t *msg, error_t error)
{
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define RfReliableMacSendP$0$AckTimer$startOneShot(arg_0x7eb11498) VirtualizeTimerC$0$Timer$startOneShot(2U, arg_0x7eb11498)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacSendP$0$PacketEx$getPacketHeader(arg_0x7e6f7010) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e6f7010)
# 139 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubAMSend$sendDone(message_t *msg, error_t error)
{
  if (/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending) 
    {
      if (error == 0) 
        {
          rf_rmac_header_t *header = /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$PacketEx$getPacketHeader(msg);

#line 146
          if (header->ack_req) 
            {
              /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$startOneShot(50);
              return;
            }
        }

      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDone(msg, error);
    }
}

# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define AMResourceP$0$AMSend$sendDone(arg_0x7eb538e0,arg_0x7eb53a68) RfReliableMacSendP$0$SubAMSend$sendDone(arg_0x7eb538e0, arg_0x7eb53a68)
# 39 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$sendDone(message_t *msg, error_t error)
{
  ...
  /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMSend$sendDone(msg, error);
}
...
# 55 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
#define RfMacBaseCsmaP$BackoffTimer$start(arg_0x7e921d18) TransformAlarmC$1$Alarm$start(arg_0x7e921d18)
# 14 "/opt/atos/tos/chips/rf2530/hardware/txrx/RfHardwareTxP.nc"
static inline void RfHardwareTxP$writeTxfifo(uint8_t *buf, uint8_t len)
{
  uint8_t i;
...
# 4 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/RfHardwareTx.nc"
#define RfMacBaseCsmaP$RfHardwareTx$txPrepare(arg_0x7e5a9c98,arg_0x7e5a9e20) RfHardwareTxP$RfHardwareTx$txPrepare(arg_0x7e5a9c98, arg_0x7e5a9e20)
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreSend.nc"
#define RfMacBaseSendP$0$SubCoreSend$send(arg_0x7e627998,arg_0x7e627b20) RfMacBaseCsmaP$CoreSend$send(arg_0x7e627998, arg_0x7e627b20)
...
# 92 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
#define TransformAlarmC$1$AlarmFrom$startAt(arg_0x7e920e78,arg_0x7e917030) HplCC2530Timer1P$0$Alarm1$startAt(arg_0x7e920e78, arg_0x7e917030)
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAMSend$sendDone(message_t *msg, error_t error)
{
  if (/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_sending) 
    {
      if (error == 0) 
        {
          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$signalDone(msg, error);
        }
      else 
        {
          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$postTask();
        }
    }
}

# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacSendP$0$AMSend$sendDone(arg_0x7eb538e0,arg_0x7eb53a68) RfReliableMacRetrySendP$0$SubAMSend$sendDone(arg_0x7eb538e0, arg_0x7eb53a68)
# 31 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$runTask(void)
{
  message_t *msg;
...
#line 40
      ...
      msg = /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg;
      result = /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_result;
    }
#line 45
    __nesc_atomic_end(__nesc_atomic); }

  /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMSend$sendDone(msg, result);
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 48
    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending = FALSE;
#line 48
    __nesc_atomic_end(__nesc_atomic); }
}
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacRetrySendP$0$AMSend$sendDone(arg_0x7eb538e0,arg_0x7eb53a68) DigRFNodeP$AMSend$sendDone(arg_0x7eb538e0, arg_0x7eb53a68)
# 48 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacRetrySendP.nc"
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$runTask(void)
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
#line 54
      ...
      if (/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_retry_times++ < 20) 
        {
          if (/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$doSend(/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_msg) != 0) 
            {
              ;
              /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$postTask();
            }
      ...
      else 
        {
          ...
          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$signalDone(/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_msg, ERR_MAC_RETRY_MAX);
        }
    }
#line 70
    __nesc_atomic_end(__nesc_atomic); }
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define RfReliableMacSendP$0$TimeoutTimer$startOneShot(arg_0x7eb11498) VirtualizeTimerC$0$Timer$startOneShot(3U, arg_0x7eb11498)
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacSendP$0$SubPacket$payloadLength(arg_0x7eb23a40) RfPacketP$Packet$payloadLength(arg_0x7eb23a40)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
#define AMResourceP$0$AMResource$send(arg_0x7e647888,arg_0x7e647a38,arg_0x7e647bc0) AMResourceCenterP$AMResource$send(AMResourceC$0$AM_RESOURCE_ID, arg_0x7e647888, arg_0x7e647a38, arg_0x7e647bc0)
# 11 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResourceP.nc"
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
  /* atomic removed: atomic calls only */
  ...
  return /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$send(addr, msg, len);
}

# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacSendP$0$SubAMSend$send(arg_0x7eb55590,arg_0x7eb55740,arg_0x7eb558c8) AMResourceP$0$AMSend$send(arg_0x7eb55590, arg_0x7eb55740, arg_0x7eb558c8)
# 89 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
  error_t result;
...
#line 102
    ...
    result = /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubAMSend$send(addr, msg, /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$SubPacket$payloadLength(msg));

    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$startOneShot(10000);

    if (result == 0) 
      {
        /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg = msg;
        /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending = TRUE;
      }
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define RfReliableMacRetrySendP$0$SubAMSend$send(arg_0x7eb55590,arg_0x7eb55740,arg_0x7eb558c8) RfReliableMacSendP$0$AMSend$send(arg_0x7eb55590, arg_0x7eb55740, arg_0x7eb558c8)
# 67 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacRetrySendP$0$AMPacket$destination(arg_0x7eb350a8) RfPacketP$AMPacket$destination(arg_0x7eb350a8)
# 67 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacRetrySendP$0$Packet$payloadLength(arg_0x7eb23a40) RfReliableMacPacketP$Packet$payloadLength(arg_0x7eb23a40)
...
# 92 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
#define AlarmToTimerC$0$Alarm$startAt(arg_0x7e920e78,arg_0x7e917030) TransformAlarmC$0$Alarm$startAt(arg_0x7e920e78, arg_0x7e917030)
...
#define VirtualizeTimerC$0$TimerFrom$startOneShotAt(arg_0x7eb05120,arg_0x7eb052b0) AlarmToTimerC$0$Timer$startOneShotAt(arg_0x7eb05120, arg_0x7eb052b0)
...
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
#define SHTP$readDoneTask$postTask(void) SchedulerBasicP$TaskBasic$postTask(SHTP$readDoneTask)
# 249 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHTP.nc"
static inline  void SHTP$WaitTimer$fired(void)
{


  if (SHTP$m_state == SHTP$SHT_STATE_TEMP || SHTP$m_state == SHTP$SHT_STATE_HUMI) 
    {
      P0_DIR &= ~(1 << 1);
      if (P0_1) {
#line 256
      ...
      if (SHTP$m_error > 0) 
        {
          SHTP$readDoneTask$postTask();
          return;
        }



      *SHTP$p_value = SHTP$recvByte(1);
      *(SHTP$p_value + 1) = SHTP$recvByte(1);
      SHTP$m_checksum = SHTP$recvByte(0);

      if (SHTP$m_state < SHTP$SHT_STATE_HUMI) 
        {
...
static inline  void /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$fired(void)
{
  if (/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending) 
    {
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDone(/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg, ERR_MAC_NO_ACK);
    }
}
...
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
#define DigRFNodeP$sensorDataTask$postTask(void) SchedulerBasicP$TaskBasic$postTask(DigRFNodeP$sensorDataTask)
# 106 "DigRFNodeP.nc"
static inline  void DigRFNodeP$Timer1$fired(void)
{
  DigRFNodeP$sensorDataTask$postTask();
}
...
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static  void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7e769030){
#line 72
  switch (arg_0x7e769030) {
#line 72
    case 0U:
#line 72
...
#line 72
    case 1U:
#line 72
      SHTP$WaitTimer$fired();
#line 72
      break;
#line 72
    case 2U:
#line 72
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$fired();
#line 72
      break;
#line 72
    case 3U:
#line 72
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$fired();
#line 72
      break;
#line 72
    case 4U:
...
#line 72
    case 7U:
#line 72
      DigRFNodeP$Timer1$fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7e769030);
#line 72
      break;
#line 72
    }
...
#line 72
# 169 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHTP.nc"
static inline void SHTP$reset(void)
...
# 62 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define SHTP$WaitTimer$startOneShot(arg_0x7eb11498) VirtualizeTimerC$0$Timer$startOneShot(1U, arg_0x7eb11498)
...
# 92 "/opt/tinyos-2.x/tos/lib/timer/Alarm.nc"
#define TransformAlarmC$0$AlarmFrom$startAt(arg_0x7e920e78,arg_0x7e917030) HplCC2530Timer1P$0$Alarm0$startAt(arg_0x7e920e78, arg_0x7e917030)
...
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
#define DigRFNodeP$sendMsgTask$postTask(void) SchedulerBasicP$TaskBasic$postTask(DigRFNodeP$sendMsgTask)
# 322 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHTP.nc"
static inline  void SHTP$SHT$calcRealValue(float *temperature, float *humidity, uint16_t raw_temperatue, uint16_t raw_humidity)
{
  ...
  *temperature = -39.66 + +0.01 * raw_temperatue;

  RH1 = -2.8E-6 * raw_humidity * raw_humidity + 0.0405 * raw_humidity + -4.0;
  *humidity = (*temperature - 25) * (0.01 + 0.00008 * raw_humidity) + RH1;
}

# 5 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHT.nc"
#define DigRFNodeP$SHT$calcRealValue(arg_0x7eb65570,arg_0x7eb65718,arg_0x7eb658b0,arg_0x7eb65a48) SHTP$SHT$calcRealValue(arg_0x7eb65570, arg_0x7eb65718, arg_0x7eb658b0, arg_0x7eb65a48)
# 64 "DigRFNodeP.nc"
static inline  void DigRFNodeP$SHT$readDone(error_t result, uint16_t temperature, uint16_t humidity)
{
...
#line 67
  ...
  DigRFNodeP$SHT$calcRealValue(&temp, &hum, temperature, humidity);
...
#line 72
    {
#line 72
      if (uart_debug_level >= uart_debug_level) {
#line 72
          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 72
            {
#line 72
              sprintf(uart_debug_buf, "temp: %f, hum: %f\r\n", temp, hum);
            }
#line 73
            __nesc_atomic_end(__nesc_atomic); }
#line 72
...
#line 72
  ...
  memcpy(DigRFNodeP$p_sensor_payload, &temp, 4);
  memcpy(DigRFNodeP$p_sensor_payload + 4, &hum, 4);


  if (result == 0) 
    {
      DigRFNodeP$sendMsgTask$postTask();
    }
  else 
    {
      DigRFNodeP$sensorDataTask$postTask();
...
# 4 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHT.nc"
#define SHTP$SHT$readDone(arg_0x7eb73d70,arg_0x7eb73f08,arg_0x7eb650b8) DigRFNodeP$SHT$readDone(arg_0x7eb73d70, arg_0x7eb73f08, arg_0x7eb650b8)
# 284 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHTP.nc"
static inline  void SHTP$readDoneTask$runTask(void)
{
  error_t result = SHTP$m_error > 0 ? FAIL : 0;



  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 290
    SHTP$m_state = SHTP$SHT_STATE_NONE;
#line 290
    __nesc_atomic_end(__nesc_atomic); }

  SHTP$SHT$readDone(result, SHTP$m_temperature, SHTP$m_humidity);
}

# 83 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacRetrySendP$0$Packet$setPayloadLength(arg_0x7eb210d0,arg_0x7eb21258) RfReliableMacPacketP$Packet$setPayloadLength(arg_0x7eb210d0, arg_0x7eb21258)
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacRetrySendP$0$AMPacket$setDestination(arg_0x7eb35c50,arg_0x7eb35de0) RfPacketP$AMPacket$setDestination(arg_0x7eb35c50, arg_0x7eb35de0)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacRetrySendP$0$PacketEx$getPacketHeader(arg_0x7e6f7010) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e6f7010)
...
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMSend$send(am_addr_t addr, message_t *msg, uint8_t len)
{
  ...
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    {
      rf_rmac_header_t *header = /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$PacketEx$getPacketHeader(msg);
      rf_metadata_t *metadata = (rf_metadata_t *)msg->metadata;
...
#line 85
      ...
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMPacket$setDestination(msg, addr);
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$Packet$setPayloadLength(msg, len);


      result = /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$doSend(msg);

      if (result == 0) 
        {
          rf_rmac_dsn++;
          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_sending = TRUE;
          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_msg = msg;
          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_retry_times = 0;
        }
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
#define DigRFNodeP$AMSend$send(arg_0x7eb55590,arg_0x7eb55740,arg_0x7eb558c8) RfReliableMacRetrySendP$0$AMSend$send(arg_0x7eb55590, arg_0x7eb55740, arg_0x7eb558c8)
# 36 "DigRFNodeP.nc"
static inline  void DigRFNodeP$sendMsgTask$runTask(void)
{

  if (DigRFNodeP$AMSend$send(1, &DigRFNodeP$m_sensor_msg, 8) != 0) 
    {
      DigRFNodeP$sensorDataTask$postTask();
    }
}

# 295 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHTP.nc"
static inline  error_t SHTP$SHT$read(void)
{

  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    {
      if (SHTP$m_state != SHTP$SHT_STATE_NONE) 
        {
          if (SHTP$m_state >= SHTP$SHT_STATE_NONE && SHTP$m_state <= SHTP$SHT_STATE_HUMI) 
            {
              {
                unsigned char __nesc_temp = 
#line 304
...
#line 307
      ...
      SHTP$m_state = SHTP$SHT_STATE_TEMP;
    }
#line 311
    __nesc_atomic_end(__nesc_atomic); }
...
# 3 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHT.nc"
#define DigRFNodeP$SHT$read(void) SHTP$SHT$read()
# 30 "DigRFNodeP.nc"
static inline  void DigRFNodeP$sensorDataTask$runTask(void)
{
  DigRFNodeP$SHT$read();
...
# 67 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define SHTP$WaitTimer$stop(void) VirtualizeTimerC$0$Timer$stop(1U)
# 49 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHTP.nc"
static inline  error_t SHTP$Init$init(void)
{
  SHTP$WaitTimer$stop();
  SHTP$m_state = SHTP$SHT_STATE_NONE;
...
#line 51
  result = ecombine(result, SHTP$Init$init());
#line 51
...
#line 51
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define DigRFNodeP$Packet$getPayload(arg_0x7eb21e20,arg_0x7eb20010) RfReliableMacPacketP$Packet$getPayload(arg_0x7eb21e20, arg_0x7eb20010)
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define DigRFNodeP$Timer1$startPeriodic(arg_0x7eb13e50) VirtualizeTimerC$0$Timer$startPeriodic(7U, arg_0x7eb13e50)
...
# 7 "/opt/atos/tos/platforms/antc5/devices/FlashIEEE.nc"
#define RfMacBaseCsmaP$FlashIEEE$GetIEEE(arg_0x7ea02f08) FlashIEEEP$FlashIEEE$GetIEEE(arg_0x7ea02f08)
...
# 67 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define RfReliableMacSendP$0$AckTimer$stop(void) VirtualizeTimerC$0$Timer$stop(2U)
#define RfReliableMacSendP$0$TimeoutTimer$stop(void) VirtualizeTimerC$0$Timer$stop(3U)
...
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AtosControl$start(void)
{
  ...
  {
    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending = FALSE;
    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_result = FAIL;


    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$TimeoutTimer$stop();
    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AckTimer$stop();

    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_started = TRUE;
...
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AtosControl$start(void)
{
  /* atomic removed: atomic calls only */
  {
    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_sending = FALSE;
    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_retry_times = 0;

    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAtosControl$start();

    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_started = TRUE;
...
static inline  error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AtosControl$start(void)
{
  /* atomic removed: atomic calls only */
  {
    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_started = TRUE;

    memset(&/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg, 0, sizeof /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg);
...
# 67 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
#define RfReliableMacSendP$1$AckTimer$stop(void) VirtualizeTimerC$0$Timer$stop(4U)
#define RfReliableMacSendP$1$TimeoutTimer$stop(void) VirtualizeTimerC$0$Timer$stop(5U)
# 204 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
static inline  error_t /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$AtosControl$start(void)
{
  /* atomic removed: atomic calls only */
...
#line 4
  result = ecombine(result, /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AtosControl$start());
#line 4
  result = ecombine(result, /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AtosControl$start());
#line 4
...
# 4 "/opt/atos/tos/lib/atos/common/AtosControl.nc"
#define DigRFNodeP$AtosControl$start(void) AtosMacP$AtosControl$start()
# 52 "DigRFNodeP.nc"
static inline  void DigRFNodeP$Boot$booted(void)
{
...
#line 56
  ;
  DigRFNodeP$AtosControl$start();

  DigRFNodeP$Timer1$startPeriodic(2000);
  DigRFNodeP$p_sensor_payload = DigRFNodeP$Packet$getPayload(&DigRFNodeP$m_sensor_msg, (void *)0);
}

# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
#define RealMainP$Boot$booted(void) DigRFNodeP$Boot$booted()
...
#line 43
                {
#line 43
                  sprintf(uart_debug_buf, "CPU SLEEP\n");
                }
#line 44
                __nesc_atomic_end(__nesc_atomic); }
#line 43
...
#line 62
                {
#line 62
                  sprintf(uart_debug_buf, "CPU WAKE UP\n");
                }
#line 63
                __nesc_atomic_end(__nesc_atomic); }
#line 62
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
#define RfActiveMessageP$Snoop$receive(arg_0x7e3c3bb0,arg_0x7eb45740,arg_0x7eb458e0,arg_0x7eb45a68) RfActiveMessageP$Snoop$default$receive(arg_0x7e3c3bb0, arg_0x7eb45740, arg_0x7eb458e0, arg_0x7eb45a68)
...
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define DigRFNodeP$AMPacket$source(arg_0x7eb35688) RfPacketP$AMPacket$source(arg_0x7eb35688)
# 90 "DigRFNodeP.nc"
static inline  message_t *DigRFNodeP$Receive$receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  DigRFNodeP$dest_address = DigRFNodeP$AMPacket$source(msg);
  DigRFNodeP$sensorDataTask$postTask();
}

# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
#define RfReliableMacReceiveP$0$Receive$receive(arg_0x7eb45740,arg_0x7eb458e0,arg_0x7eb45a68) DigRFNodeP$Receive$receive(arg_0x7eb45740, arg_0x7eb458e0, arg_0x7eb45a68)
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$0$AMPacket$source(arg_0x7eb35688) RfPacketP$AMPacket$source(arg_0x7eb35688)
...
# 4 "/opt/atos/tos/lib/atos/utils/DsnFilter.nc"
#define RfReliableMacReceiveP$0$DsnFilter$filter(arg_0x7e3f3b78,arg_0x7e3f3d00) DsnFilterCenterP$0$DsnFilter$filter(0U, arg_0x7e3f3b78, arg_0x7e3f3d00)
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$0$AMPacket$setDestination(arg_0x7eb35c50,arg_0x7eb35de0) RfPacketP$AMPacket$setDestination(arg_0x7eb35c50, arg_0x7eb35de0)
...
# 166 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$0$AMPacket$group(arg_0x7eb31590) RfPacketP$AMPacket$group(arg_0x7eb31590)
...
#define RfReliableMacReceiveP$0$AMPacket$setGroup(arg_0x7eb31c20,arg_0x7eb31db0) RfPacketP$AMPacket$setGroup(arg_0x7eb31c20, arg_0x7eb31db0)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
#define RfReliableMacReceiveP$0$RfReliableMacAck$fillAckMessage(arg_0x7e695b48,arg_0x7e695cd8,arg_0x7e695e88,arg_0x7e694068) RfReliableMacAckP$RfReliableMacAck$fillAckMessage(arg_0x7e695b48, arg_0x7e695cd8, arg_0x7e695e88, arg_0x7e694068)
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacReceiveP$0$SubPacket$getPayload(arg_0x7eb21e20,arg_0x7eb20010) RfPacketP$Packet$getPayload(arg_0x7eb21e20, arg_0x7eb20010)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacReceiveP$0$PacketEx$getPacketHeader(arg_0x7e6f7010) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e6f7010)


#define RfReliableMacReceiveP$0$PacketEx$isValidPacket(arg_0x7e6f74e8) RfReliableMacPacketP$PacketEx$isValidPacket(arg_0x7e6f74e8)
# 57 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacReceiveP.nc"
static inline  message_t */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubReceive$receive(message_t *msg, void *payload, uint8_t len)
{
  if (/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$PacketEx$isValidPacket(msg)) 
    {
      rf_rmac_header_t *header = /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$PacketEx$getPacketHeader(msg);
      rf_ack_t *ack_header = (rf_ack_t *)/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubPacket$getPayload(&/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg, (void *)0);
      ...
      if (header->ack_req) 
        {
          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$RfReliableMacAck$fillAckMessage(msg, header->dsn, &/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg, ack_header);

          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$setGroup(&/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg, /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$group(msg));

          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$setDestination(&/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$m_ack_msg, /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$source(msg));

          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$postTask();
        }


      if (!/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$DsnFilter$filter(/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$AMPacket$source(msg), header->dsn)) 
        {
          return msg;
        }

      return /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$Receive$receive(msg, payload, len);
    }
...
#define AtosNetStdP$AtosNetStd$receivedTraceAck(arg_0x7e3521f8,arg_0x7e3523b8) AtosNetStdP$AtosNetStd$default$receivedTraceAck(arg_0x7e3521f8, arg_0x7e3523b8)
...
#define AtosNetStdP$AtosNetStd$receivedTrace(arg_0x7e354b58,arg_0x7e354d08) AtosNetStdP$AtosNetStd$default$receivedTrace(arg_0x7e354b58, arg_0x7e354d08)
...
# 17 "/opt/atos/tos/lib/atos/net/AtosNetStd/AtosNetStd.nc"
#define AtosNetStdP$AtosNetStd$receivedReboot(arg_0x7e3546a8) AtosNetStdP$AtosNetStd$default$receivedReboot(arg_0x7e3546a8)
...
# 8 "/opt/atos/tos/platforms/antc5/devices/FlashIEEE.nc"
#define AtosNetStdP$FlashIEEE$WriteIEEE(arg_0x7ea013d8) FlashIEEEP$FlashIEEE$WriteIEEE(arg_0x7ea013d8)
...
#define AtosNetStdP$AtosNetStd$receivedSetIEEE(arg_0x7e3541f8) AtosNetStdP$AtosNetStd$default$receivedSetIEEE(arg_0x7e3541f8)
...
#define AtosNetStdP$AtosNetStd$receivedDiscovery(arg_0x7e355d20) AtosNetStdP$AtosNetStd$default$receivedDiscovery(arg_0x7e355d20)
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define AtosNetStdP$AMPacket$source(arg_0x7eb35688) RfPacketP$AMPacket$source(arg_0x7eb35688)
...
#define AtosNetStdP$AtosNetStd$receivedNodeStatusUp(arg_0x7e355698,arg_0x7e355850) AtosNetStdP$AtosNetStd$default$receivedNodeStatusUp(arg_0x7e355698, arg_0x7e355850)
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
#define RfReliableMacReceiveP$1$Receive$receive(arg_0x7eb45740,arg_0x7eb458e0,arg_0x7eb45a68) AtosNetStdP$Receive$receive(arg_0x7eb45740, arg_0x7eb458e0, arg_0x7eb45a68)
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$1$AMPacket$source(arg_0x7eb35688) RfPacketP$AMPacket$source(arg_0x7eb35688)
# 4 "/opt/atos/tos/lib/atos/utils/DsnFilter.nc"
#define RfReliableMacReceiveP$1$DsnFilter$filter(arg_0x7e3f3b78,arg_0x7e3f3d00) DsnFilterCenterP$0$DsnFilter$filter(0U, arg_0x7e3f3b78, arg_0x7e3f3d00)
# 56 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacReceiveP$1$AMPacket$setDestination(arg_0x7eb35c50,arg_0x7eb35de0) RfPacketP$AMPacket$setDestination(arg_0x7eb35c50, arg_0x7eb35de0)
#line 166
#define RfReliableMacReceiveP$1$AMPacket$group(arg_0x7eb31590) RfPacketP$AMPacket$group(arg_0x7eb31590)
...
#define RfReliableMacReceiveP$1$AMPacket$setGroup(arg_0x7eb31c20,arg_0x7eb31db0) RfPacketP$AMPacket$setGroup(arg_0x7eb31c20, arg_0x7eb31db0)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
#define RfReliableMacReceiveP$1$RfReliableMacAck$fillAckMessage(arg_0x7e695b48,arg_0x7e695cd8,arg_0x7e695e88,arg_0x7e694068) RfReliableMacAckP$RfReliableMacAck$fillAckMessage(arg_0x7e695b48, arg_0x7e695cd8, arg_0x7e695e88, arg_0x7e694068)
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfReliableMacReceiveP$1$SubPacket$getPayload(arg_0x7eb21e20,arg_0x7eb20010) RfPacketP$Packet$getPayload(arg_0x7eb21e20, arg_0x7eb20010)
# 6 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacReceiveP$1$PacketEx$getPacketHeader(arg_0x7e6f7010) RfReliableMacPacketP$PacketEx$getPacketHeader(arg_0x7e6f7010)


#define RfReliableMacReceiveP$1$PacketEx$isValidPacket(arg_0x7e6f74e8) RfReliableMacPacketP$PacketEx$isValidPacket(arg_0x7e6f74e8)
# 57 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacReceiveP.nc"
static inline  message_t */*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$SubReceive$receive(message_t *msg, void *payload, uint8_t len)
{
...
#define RfReliableMacAckP$RfReliableMacAckEvent$receiveAckMessage(arg_0x7e414368,arg_0x7e414518,arg_0x7e4146c8) RfReliableMacAckP$RfReliableMacAckEvent$default$receiveAckMessage(arg_0x7e414368, arg_0x7e414518, arg_0x7e4146c8)
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
#define RfReliableMacSendP$1$RfReliableMacAck$receiveAckMessage(arg_0x7e694540,arg_0x7e6946f0,arg_0x7e6948a0) RfReliableMacAckP$RfReliableMacAck$receiveAckMessage(arg_0x7e694540, arg_0x7e6946f0, arg_0x7e6948a0)
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacSendP$1$AMPacket$source(arg_0x7eb35688) RfPacketP$AMPacket$source(arg_0x7eb35688)
#line 67
#define RfReliableMacSendP$1$AMPacket$destination(arg_0x7eb350a8) RfPacketP$AMPacket$destination(arg_0x7eb350a8)
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAck.nc"
#define RfReliableMacSendP$0$RfReliableMacAck$receiveAckMessage(arg_0x7e694540,arg_0x7e6946f0,arg_0x7e6948a0) RfReliableMacAckP$RfReliableMacAck$receiveAckMessage(arg_0x7e694540, arg_0x7e6946f0, arg_0x7e6948a0)
# 77 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfReliableMacSendP$0$AMPacket$source(arg_0x7eb35688) RfPacketP$AMPacket$source(arg_0x7eb35688)
#line 67
#define RfReliableMacSendP$0$AMPacket$destination(arg_0x7eb350a8) RfPacketP$AMPacket$destination(arg_0x7eb350a8)
# 158 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacSendP.nc"
static inline  message_t */*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$ReceiveAck$receive(message_t *ack_msg, void *payload, uint8_t len)
{
  if (/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_sending) 
    {
      rf_metadata_t *metadata = (rf_metadata_t *)/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg->metadata;
      rf_rmac_header_t *header = /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$PacketEx$getPacketHeader(/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg);
...
#line 169
      header->ack_req
       && header->dsn == __nesc_ntoh_uint8((unsigned char *)&ack_header->dsn)
       && /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$source(ack_msg) == /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$destination(/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg)
       && /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$destination(ack_msg) == /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$AMPacket$source(/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg)) 

        {
          ...
          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$RfReliableMacAck$receiveAckMessage(/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg, ack_msg, ack_header);


          /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDone(/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg, 0);
        }
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static  message_t *RfActiveMessageP$Receive$receive(uint8_t arg_0x7e3c33f8, message_t *arg_0x7eb45740, void *arg_0x7eb458e0, uint8_t arg_0x7eb45a68){
#line 67
  nx_struct message_t *result;
#line 67

#line 67
  switch (arg_0x7e3c33f8) {
#line 67
    case 123:
#line 67
      result = /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$SubReceive$receive(arg_0x7eb45740, arg_0x7eb458e0, arg_0x7eb45a68);
#line 67
      break;
#line 67
    case 124:
#line 67
      result = /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$ReceiveAck$receive(arg_0x7eb45740, arg_0x7eb458e0, arg_0x7eb45a68);
#line 67
      break;
#line 67
    case 240U:
#line 67
      result = /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$1$SubReceive$receive(arg_0x7eb45740, arg_0x7eb458e0, arg_0x7eb45a68);
#line 67
      break;
#line 67
    case 241:
#line 67
      result = /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$1$ReceiveAck$receive(arg_0x7eb45740, arg_0x7eb458e0, arg_0x7eb45a68);
#line 67
      break;
#line 67
    default:
#line 67
      result = RfActiveMessageP$Receive$default$receive(arg_0x7e3c33f8, arg_0x7eb45740, arg_0x7eb458e0, arg_0x7eb45a68);
#line 67
      break;
#line 67
    }
...
#define RfActiveMessageP$AMPacket$isForMe(arg_0x7eb34f00) RfPacketP$AMPacket$isForMe(arg_0x7eb34f00)
# 108 "/opt/tinyos-2.x/tos/interfaces/Packet.nc"
#define RfActiveMessageP$Packet$getPayload(arg_0x7eb21e20,arg_0x7eb20010) RfPacketP$Packet$getPayload(arg_0x7eb21e20, arg_0x7eb20010)
...
# 136 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
#define RfActiveMessageP$AMPacket$type(arg_0x7eb32660) RfPacketP$AMPacket$type(arg_0x7eb32660)
...
# 8 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfActiveMessageP$PacketEx$isValidPacket(arg_0x7e6f74e8) RfPacketP$PacketEx$isValidPacket(arg_0x7e6f74e8)
# 20 "/opt/atos/tos/lib/atos/net/AtosMac/AM/RfActiveMessageP.nc"
static inline  void RfActiveMessageP$CoreReceive$receive(message_t *msg)
{
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/CoreReceive.nc"
#define RfMacBaseReceiveP$CoreReceive$receive(arg_0x7e3be030) RfActiveMessageP$CoreReceive$receive(arg_0x7e3be030)
# 12 "/opt/atos/tos/lib/atos/net/AtosMac/macbase/RfMacBaseReceiveP.nc"
static inline  void RfMacBaseReceiveP$RfHardwareRx$rxPacket(uint8_t *buf, uint8_t len)
{
...
# 5 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/RfHardwareRx.nc"
#define RfHardwareRxP$0$RfHardwareRx$rxPacket(arg_0x7e56b7e8,arg_0x7e56b970) RfMacBaseReceiveP$RfHardwareRx$rxPacket(arg_0x7e56b7e8, arg_0x7e56b970)
...
# 4 "/opt/atos/tos/lib/atos/kernel/TopTask/TopTaskHandler.nc"
inline static  void TopTaskMgrP$TopTaskHandler$handler(uint8_t arg_0x7ebb0aa8){
#line 4
  switch (arg_0x7ebb0aa8) {
#line 4
    case 0:
#line 4
...
#line 4
    default:
#line 4
      TopTaskMgrP$TopTaskHandler$default$handler(arg_0x7ebb0aa8);
#line 4
      break;
#line 4
    }
...
# 8 "/opt/atos/tos/lib/atos/net/AtosMac/interfaces/PacketEx.nc"
#define RfReliableMacPacketP$SubPacketEx$isValidPacket(arg_0x7e6f74e8) RfPacketP$PacketEx$isValidPacket(arg_0x7e6f74e8)
...
# 4 "/opt/atos/tos/lib/atos/net/AtosMac/mac/RfReliableMacAckEvent.nc"
#define RfReliableMacAckP$RfReliableMacAckEvent$fillAckMessage(arg_0x7e415968,arg_0x7e415af8,arg_0x7e415ca8,arg_0x7e415e58) RfReliableMacAckP$RfReliableMacAckEvent$default$fillAckMessage(arg_0x7e415968, arg_0x7e415af8, arg_0x7e415ca8, arg_0x7e415e58)
...
# 50 "/opt/tinyos-2.x/tos/interfaces/GpioCapture.nc"
#define HplCC2530Timer1P$0$CaptureChannel2$captured(arg_0x7e8e7ba0) HplCC2530Timer1P$0$CaptureChannel2$default$captured(arg_0x7e8e7ba0)
...
# 76 "/opt/atos/tos/platforms/antc5/interrupt/PlatformInterruptC.nc"
static inline   void PlatformInterruptC$INT_UART0_RX$default$fired(void)
{
  URX0IF = 0;
}
...
# 4 "/opt/atos/tos/platforms/antc5/interrupt/PlatformIntHandler.nc"
#define PlatformInterruptC$INT_UART0_RX$fired(void) PlatformInterruptC$INT_UART0_RX$default$fired()
# 88 "/opt/atos/tos/platforms/antc5/interrupt/PlatformInterruptC.nc"
static inline   void PlatformInterruptC$INT_UART0_TX$default$fired(void)
{
  UTX0IF = 0;
}
...
# 4 "/opt/atos/tos/platforms/antc5/interrupt/PlatformIntHandler.nc"
#define PlatformInterruptC$INT_UART0_TX$fired(void) PlatformInterruptC$INT_UART0_TX$default$fired()
...
#line 64
    case DigRFNodeP$sensorDataTask:
#line 64
      DigRFNodeP$sensorDataTask$runTask();
#line 64
      break;
#line 64
    case DigRFNodeP$sendMsgTask:
#line 64
      DigRFNodeP$sendMsgTask$runTask();
#line 64
      break;
#line 64
    case SHTP$readDoneTask:
#line 64
      SHTP$readDoneTask$runTask();
#line 64
      break;
#line 64
...
#line 64
      break;
#line 64
    case /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask:
#line 64
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$resendTask$runTask();
#line 64
      break;
#line 64
    case /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask:
#line 64
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$runTask();
#line 64
      break;
#line 64
...
#line 64
      break;
#line 64
    case /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask:
#line 64
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.RfReliableMacReceiveP*/RfReliableMacReceiveP$0$sendAckTask$runTask();
#line 64
      break;
#line 64
...
#line 67
  result = RfReliableMacPacketP$Packet$payloadLength(arg_0x7eb23a40);
#line 67
...
# 7 "/opt/atos/tos/lib/atos/net/AtosMac/AM/AMResource.nc"
static  void AMResourceCenterP$AMResource$sendDone(uint8_t arg_0x7e631dd8, message_t *arg_0x7e6460a8, error_t arg_0x7e646230){
#line 7
  switch (arg_0x7e631dd8) {
#line 7
    case /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC*/AMResourceC$0$AM_RESOURCE_ID:
#line 7
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$0$AMResource$sendDone(arg_0x7e6460a8, arg_0x7e646230);
#line 7
      break;
#line 7
    case /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC*/AMResourceC$2$AM_RESOURCE_ID:
#line 7
      /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.AMResourceC.AMResourceP*/AMResourceP$1$AMResource$sendDone(arg_0x7e6460a8, arg_0x7e646230);
#line 7
      break;
#line 7
    case /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC*/AMResourceC$3$AM_RESOURCE_ID:
#line 7
      /*AtosNetStdC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$2$AMResource$sendDone(arg_0x7e6460a8, arg_0x7e646230);
#line 7
      break;
#line 7
    case /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC*/AMResourceC$1$AM_RESOURCE_ID:
#line 7
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacReceiveC.AMResourceC.AMResourceP*/AMResourceP$3$AMResource$sendDone(arg_0x7e6460a8, arg_0x7e646230);
#line 7
      break;
#line 7
    default:
#line 7
      AMResourceCenterP$AMResource$default$sendDone(arg_0x7e631dd8, arg_0x7e6460a8, arg_0x7e646230);
#line 7
      break;
#line 7
    }
...
#line 57
      ...
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_msg = msg;
      /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$m_result = result;
    }
#line 66
    __nesc_atomic_end(__nesc_atomic); }

  /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacSendC.RfReliableMacSendP*/RfReliableMacSendP$0$signalDoneTask$postTask();
}
...
#line 33
  ...
  /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMSend$sendDone(msg, result);
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 38
    /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$m_sending = FALSE;
#line 38
...
static error_t /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$doSend(message_t *msg)
{
  return /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$SubAMSend$send(/*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$AMPacket$destination(msg), msg, /*DigRFNodeC.PlatformMacC.RfMacC.RfReliableMacSendC.RfReliableMacRetrySendP*/RfReliableMacRetrySendP$0$Packet$payloadLength(msg));
}
...
# 96 "/opt/atos/tos/lib/atos/sensor/drv/SHTxx/SHTP.nc"
static uint8_t SHTP$recvByte(uint8_t ack)
{
  uint8_t i;
#line 98
...

{
  ...
  if (SHTP$m_state == SHTP$SHT_STATE_TEMP) 
    {

      SHTP$p_value = (uint8_t *)&SHTP$m_temperature;
      SHTP$m_error += SHTP$sendByte(0x03);
    }
  else 
    {

      SHTP$p_value = (uint8_t *)&SHTP$m_humidity;
      SHTP$m_error += SHTP$sendByte(0x05);
    }
  ...
  SHTP$WaitTimer$startOneShot(300);

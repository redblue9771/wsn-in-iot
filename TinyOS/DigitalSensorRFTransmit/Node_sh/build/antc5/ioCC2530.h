...
#define XDATA_ADDR(x)    ((uint32_t)(x) /* xdata_ptr */)
#define CODE_ADDR(x)     ((uint32_t)(x) /* xcode_ptr */)
...
#define XDATA_PTR(x)    (((uint32_t)(x) & 0xFFFF) | 0x010000)
#define CODE_PTR(x)     (((uint32_t)(x) & 0xFFFF) | 0xFF0000)
...
SFR(  SLEEP     ,  0xBE  )   /*  Sleep Mode Control Command                         */
...
SFR(  CLKCON    ,  0xC6  )   /*  Clock Control Command                              */
...
SFR(  P0_ALT    ,  0xF3  )   /*  Port 0 Function Select                             */
SFR(  P1_ALT    ,  0xF4  )   /*  Port 1 Function Select                             */
SFR(  P2_ALT    ,  0xF5  )   /*  Port 2 Function Select                             */
...
SFR(  P0_DIR    ,  0xFD  )   /*  Port 0 Direction                                   */
SFR(  P1_DIR    ,  0xFE  )   /*  Port 1 Direction                                   */
SFR(  P2_DIR    ,  0xFF  )   /*  Port 2 Direction                                   */
